...
class ContentManagementService {
  ...
  static const Map<String, List<String>> screenGroups = {
    'ניהול קטלוג': [],  // Special: handled by AdminCatalogTab, not text editor
    'ניווט': [
      'tabHome',
      'tabBookings',
      'tabChat',
    ...
    'סטורי': [
      'storiesRowSectionTitle',
      'storiesRowActiveCount',
      'storiesMyStoryLabel',
      'storiesAddStoryLabel',
      'storiesDefaultProviderName',
      'defaultProviderName',
      'storiesTimeRemainingHours',
      'storiesTimeRemainingMinutes',
      'storiesDeleteDialogTitle',
      'storiesDeleteDialogBody',
      'storiesDeleteConfirmButton',
      'storiesDeletedSnackbar',
      'storiesLikeNotificationTitle',
      'storiesQuickReplyAvailability',
      'storiesQuickReplyCost',
      'storiesQuickReplySendPhoto',
      'storiesLoadError',
      'storiesAvailableNow',
      'storiesBookOrMessageButton',
      'storiesViewFullProfileLink',
      'storiesUploadSourceTitle',
      'storiesUploadGalleryLabel',
      'storiesUploadGallerySub',
      'storiesUploadCameraLabel',
      'storiesUploadCameraSub',
      'storiesNewStoryNotificationTitle',
      'storiesNewStoryNotificationDetail',
      'storiesPublishedSnackbar',
      'storiesUploadErrorPermission',
      'storiesUploadCancelled',
      'storiesUploadErrorNetwork',
      'storiesUploadErrorGeneric',
      'storiesUploadPanelTitle',
      'storiesUploadPanelSubtitle',
      'storiesPerkSearchBoost',
      'storiesPerk24Hours',
      'storiesSelectVideoButton',
      'storiesVideoRecommendedLength',
      'storiesReplaceVideoButton',
      'storiesUploadingProgress',
      'storiesPreparingUpload',
      'storiesPublishButton',
    ],
    'חיפוש — פילטרים': [
      'searchFilterPlumber',
      'searchFilterElectrician',
      'searchFilterCleaning',
      'searchFilterGardening',
      'searchFilterPrivateLessons',
      'searchFilterBusinessConsulting',
      'searchFilterDesign',
      'searchFilterTranslation',
      'searchFilterMassage',
      'searchFilterFitness',
      'searchFilterBeauty',
      'searchFilterNutrition',
      'searchFilterMusic',
      'searchFilterPainting',
      'searchFilterWriting',
      'searchFilterCoding',
    ],
    'הזמנות — טפסים': [
      'bookingCancelDialogTitle',
      'bookingCancelPenaltyWarning',
      'bookingCancelConfirmMessage',
      'bookingCancelRefundBreakdown',
      'bookingCancelYesPenalty',
      'bookingCancelYes',
      'bookingTipDialogTitle',
      'bookingTipConfirmMessage',
      'bookingTipSendButton',
      'bookingReviewPromptTitle',
      'bookingSubmitReviewButton',
    ],
    'הזמנות — סטטוסים': [
      ...
      'statusDisputed',
      'statusSplitResolved',
      'statusCancelledWithPenalty',
      'statusBadgeEscrow',
      'statusBadgePending',
      'statusBadgeCompleted',
      'statusBadgeCancelled',
      'statusBadgeCancelledPenalty',
      'statusBadgeDisputed',
      'statusBadgeRefunded',
      'statusBadgeSplit',
