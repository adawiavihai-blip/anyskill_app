...
class _LiveActivityTabState extends State<LiveActivityTab> {
  ...
  static const Map<String, IconData> _icons = {
    ...
    'expert_application': Icons.workspace_premium_rounded,
  ...
  static const Map<String, Color> _colors = {
    ...
    'expert_application': Color(0xFFF59E0B),
  ...
  static bool _isSuccess(String type) => const {
    'job_accepted',
    'registration',
    'reengagement_sent',
  }.contains(type);
  ...
  void _onTap(BuildContext ctx, Map<String, dynamic> d, String type) {
    switch (type) {
      ...
      case 'registration':
        ...
        final name =
            (d['providerName'] ?? d['title'] ?? 'נותן שירות') as String;
        if (uid.isNotEmpty) {
          Navigator.push(
            ctx,
            MaterialPageRoute(
              builder:
                  (_) => ExpertProfileScreen(expertId: uid, expertName: name),
            ),
          );
        }
      ...
      case 'demo_contact':
        ...
        final name = d['providerName'] as String? ?? 'נותן שירות';
        if (uid.isNotEmpty) {
          Navigator.push(
            ctx,
            MaterialPageRoute(
            ...
            builder: (context, snap) {
              ...
              final docs =
                  _filter == 'הכל'
                      ? allDocs
                      : allDocs.where((doc) {
                        final t = (doc.data() as Map)['type'] as String? ?? '';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_filter != 'הכל') ...[
                        ...
                        TextButton.icon(
                          onPressed: () => setState(() => _filter = 'הכל'),
                          icon: const Icon(
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return GestureDetector(
                    onTap: tappable ? () => _onTap(context, d, type) : null,
                    child: Container(
                      decoration: BoxDecoration(
                        color: bg,
