...
final Map<String, Map<String, String>> _translations = {
  ...
  'he': {
    ...
    // ── Home Tab (New Keys) ─────────────────────────────────────────────────
    'homeCategoryNotFound':   'לא נמצאה קטגוריה עבור "{query}"',
    'homeCategoryCount':      '{count} קטגוריות',
    'homeShowAll':            'הצג הכל',
    'homeCommunityButton':    'למען הקהילה',
    'homeUrgentSearch':       'חיפוש דחוף',
    'reengagementDefaultMessage': 'מוכן להזמין שוב?',
    'reengagementBadgeLabel': 'הצעה חכמה',
    'reengagementCtaButton':  'הזמן עכשיו',
    'bannerWelcomeTitle':     'ברוכים הבאים ל-AnySkill',
    'bannerWelcomeSubtitle':  'מצא מומחים מהשכונה שלך',
    'bannerProfessionalTitle': 'שירות מקצועי בלחיצה אחת',
    'bannerProfessionalSubtitle': 'שיפוצים • ניקיון • צילום ועוד',
    'bannerBecomeExpertTitle': 'הפוך למומחה היום',
    'bannerBecomeExpertSubtitle': 'פרסם את השירות שלך והתחל להרוויח',
    'adminEmailTestSent':     'מייל בדיקה נשלח! בדוק את תיבת הדואר.',
    'defaultExpertName':      'המומחה',
    // ── Search Bar & Filters ────────────────────────────────────────────────
    'searchBarHint':          'מה בא לך לעשות היום?',
    'searchFilterPlumber':    'שרברב',
    'searchFilterElectrician': 'חשמלאי',
    'searchFilterCleaning':   'ניקיון',
    'searchFilterGardening':  'גינון',
    'searchFilterPrivateLessons': 'שיעורים פרטיים',
    'searchFilterBusinessConsulting': 'ייעוץ עסקי',
    'searchFilterDesign':     'עיצוב',
    'searchFilterTranslation': 'תרגום',
    'searchFilterMassage':    'עיסוי',
    'searchFilterFitness':    'כושר ואימון',
    'searchFilterBeauty':     'יופי',
    'searchFilterNutrition':  'תזונה',
    'searchFilterMusic':      'מוסיקה',
    'searchFilterPainting':   'ציור',
    'searchFilterWriting':    'כתיבה',
    'searchFilterCoding':     'תכנות',
    // ── Expert Card & Stories ──────────────────────────────────────────────
    'expertCardLiveStoryBadge': 'סיפור חי',
    'storiesRowSectionTitle': 'סטורי נותני השירות',
    'storiesRowActiveCount':  '{count} פעיל{isPlural}',
    'storiesMyStoryLabel':    'הסיפור שלי',
    'storiesAddStoryLabel':   'הוסף סטורי',
    'storiesDefaultProviderName': 'אני',
    'defaultProviderName':    'ספק',
    'storiesTimeRemainingHours': '{hours}שע׳',
    'storiesTimeRemainingMinutes': '{minutes}ד׳',
    'storiesDeleteDialogTitle': 'למחוק את הסטורי?',
    'storiesDeleteDialogBody': 'הסטורי יימחק לצמיתות ולא ניתן יהיה לשחזרו.',
    'storiesDeleteConfirmButton': 'מחק',
    'storiesDeletedSnackbar':  'הסטורי נמחק בהצלחה 🗑️',
    'storiesLikeNotificationTitle': '❤️ לייק לסטורי של {name}',
    'storiesQuickReplyAvailability': 'האם אתה זמין באזור שלי?',
    'storiesQuickReplyCost': 'מה עלות הביקור?',
    'storiesQuickReplySendPhoto': 'אפשר לשלוח צילום של התקלה?',
    'storiesLoadError':       'לא ניתן לטעון את הסיפור',
    'storiesAvailableNow':    'זמין עכשיו',
    'storiesBookOrMessageButton': 'הזמן עכשיו / שלח הודעה',
    'storiesViewFullProfileLink': 'צפה בפרופיל המלא ומחירים ←',
    'storiesUploadSourceTitle': 'בחר מקור',
    'storiesUploadGalleryLabel': 'גלריה',
    'storiesUploadGallerySub': 'בחר סרטון קיים',
    'storiesUploadCameraLabel': 'מצלמה',
    'storiesUploadCameraSub': 'צלם עכשיו',
    'storiesNewStoryNotificationTitle': '📱 סטורי חדש: {name}',
    'storiesNewStoryNotificationDetail': 'שירות: {service}',
    'storiesPublishedSnackbar': 'הסיפור שלך פורסם! ✨ תקף ל-24 שעות',
    'storiesUploadErrorPermission': 'שגיאת הרשאה — נסה להתחבר מחדש',
    'storiesUploadCancelled': 'ההעלאה בוטלה',
    'storiesUploadErrorNetwork': 'שגיאת רשת — בדוק את החיבור ונסה שוב',
    'storiesUploadErrorGeneric': 'שגיאה בהעלאה — נסה שוב',
    'storiesUploadPanelTitle': 'סיפור מיומנות',
    'storiesUploadPanelSubtitle': 'הצג את הכישרון שלך • תקף 24 שעות',
    'storiesPerkSearchBoost': 'בוסט בחיפוש',
    'storiesPerk24Hours':     '24 שעות',
    'storiesSelectVideoButton': 'בחר סרטון מהגלריה',
    'storiesVideoRecommendedLength': 'מומלץ עד 60 שניות',
    'storiesReplaceVideoButton': 'החלף סרטון',
    'storiesUploadingProgress': 'מעלה... {percent}%',
    'storiesPreparingUpload': 'מכין...',
    'storiesPublishButton':   'פרסם סיפור',
    // ── Bookings & Orders ────────────────────────────────────────────────────
    'bookingsAppBarExpert':   'העבודות שלי',
    'bookingsAppBarCustomer': 'ההזמנות שלי',
    'bookingsTabCalendar':    'יומן',
    'bookingsTabMyTasks':     'משימות שלי',
    'bookingsTabActive':      'פעילות',
    'bookingsTabHistory':     'היסטוריה',
    'bookingsAvailabilityTitle': 'ניהול זמינות',
    'bookingsAvailabilityHint': 'לחץ על תאריך לבחירה. לחיצה ארוכה לחסימה/שחרור.',
    'bookingsCalendarBlocked': 'חסום',
    'bookingsCalendarBooking': 'הזמנה',
    'calendarFormatMonth':    'חודש',
    'bookingsBlockedDatesLabel': 'תאריכים חסומים:',
    'bookingsSaveBlockedDates': 'שמור חסימות',
    'bookingDetailsTitle':    'פרטי הזמנה',
    'bookingDetailId':        'מזהה הזמנה',
    'bookingDetailExpert':    'מומחה',
    'bookingDetailCustomer':  'לקוח',
    'bookingDetailStatus':    'סטטוס',
    'bookingDetailAmount':    'סכום',
    'bookingDetailDate':      'תאריך',
    'bookingDetailTime':      'שעה',
    'bookingCancelDialogTitle': 'ביטול הזמנה',
    'bookingCancelPenaltyWarning': 'אזהרה: חלון הביטול החינמי עבר...',
    'bookingCancelConfirmMessage': 'האם לבטל את ההזמנה? ₪{amount} יוחזרו לארנק שלך.',
    'bookingCancelRefundBreakdown': 'תקבל בחזרה: ₪{customer}\nישולם למומחה: ₪{expert}',
    'bookingCancelYesPenalty': 'כן, בטל (קנס ₪{penalty})',
    'bookingCancelYes':       'כן, בטל',
    'bookingCancelledRefundSnackbar': 'ההזמנה בוטלה — ₪{amount} הוחזרו לארנק',
    'bookingErrorCancelling': 'שגיאה בביטול: {error}',
    'bookingProviderCancelTitle': 'ביטול מצד הספק',
    'bookingProviderCancelMessage': 'ביטול מצד הספק מחזיר ללקוח 100%...',
    'bookingProviderCancelledSnackbar': 'ההזמנה בוטלה — הלקוח יקבל החזר מלא',
    'bookingTipDialogTitle': 'שלח טיפ',
    'bookingTipConfirmMessage': 'לשלוח ₪{amount} טיפ ל-{expert}?',
    'bookingTipSendButton':   'שלח',
    'bookingTipSentSnackbar': '₪{amount} נשלחו ל-{expert} 🎉',
    'bookingTipErrorSnackbar': 'שגיאה בשליחת טיפ: {error}',
    'bookingReviewPromptTitle': 'איך היה השירות?',
    'bookingSubmitReviewButton': 'שלח ביקורת ⭐',
    'bookingReviewSentConfirmation': 'ביקורת נשלחה — תודה!',
    'bookingReceiptChip':     'קבלה',
    'bookingAmountEscrow':    'בנאמנות',
    'bookingAmountLabel':     'סכום',
    'bookingReleasePaymentButton': 'אשר ושחרר תשלום',
    'bookingOpenDisputeButton': 'יש בעיה — פתח מחלוקת',
    'bookingCancelButton':    'בטל הזמנה',
    'bookingTipLabel':        'שלח טיפ:',
    'bookingExpertOnTheWay':  'המומחה בדרך אליך',
    'bookingViewExpertOnMap': 'צפה במומחה על המפה 📍',
    'bookingWorkStartedMinutesAgo': 'העבודה החלה לפני {minutes} דקות',
    'bookingRebookButton':    'הזמן שוב את {expert}',
    'bookingCallExpertButton': '📞 התקשר למומחה',
    'bookingQuickChatButton': '💬 צ\'אט מהיר',
    'bookingDetailsFooter':   'פרטי הזמנה',
    'bookingStepReceived':    'התקבלה',
    'bookingStepOnTheWay':    'בדרך',
    'bookingStepInProgress':  'בעבודה',
    'bookingStepDone':        'הושלם',
    'bookingNavigateButton':  'נווט לעבודה 🚗',
    'bookingStartWorkButton': 'הגעתי — התחל עבודה 🛠️',
    'bookingMarkDoneButton':  'סיימתי את העבודה',
    'bookingChatWithCustomerButton': 'צ\'אט עם לקוח',
    'bookingWaitingForClientApproval': 'ממתין לאישור הלקוח',
    'bookingShowReceiptButton': 'הצג קבלה',
    'bookingShareReviewButton': 'שתף חוות דעת ⭐',
    'bookingReviewWindowExpired': 'חלון הביקורת פג (7 ימים)',
    'bookingsEarningsSummaryLabel': 'סה"כ רווח צפוי',
    'bookingsActiveCountLabel': 'הזמנות',
    'bookingLoadError':       'לא ניתן לטעון את ההזמנות כרגע. אנא נסה שוב.',
    'bookingsEmptyExpertTitle': 'אין משימות עדיין',
    'bookingsEmptyHistoryTitle': 'אין היסטוריית הזמנות',
    'bookingsEmptyCustomerTitle': 'יש לך משימה? לנו יש את האדם הנכון בשבילה.',
    'bookingsEmptyExpertSubtitle': 'הזמנות מלקוחות יופיעו כאן. ודא שהפרופיל שלך מעודכן.',
    'bookingsEmptyHistorySubtitle': 'הזמנות שהושלמו יופיעו כאן.',
    'bookingsEmptyCustomerSubtitle': 'אל תתפשר על פחות מהטוב ביותר. בוא נתחיל?',
    'bookingsEmptyCtaButton': 'הזמן שירות עכשיו',
    'bookingsGroupActive':    'פעיל',
    'bookingsGroupHistory':   'היסטוריה',
    'bookingsGroupThisMonth': 'החודש',
    'bookingsGroupLastMonth': 'חודש שעבר',
    'bookingsGroupOlder':     'ישן יותר',
    'bookingExpertCompletedMessage': '✅ המומחה סיים את העבודה! לחץ על "אשר ושחרר"...',
    'bookingErrorSaving':     'שגיאה בשמירה: {error}',
    'defaultCustomerName':    'לקוח',
    'bookingStatusUpdateFailed': 'הסטטוס לא עודכן — נסה שוב (status: {status})',
    'bookingTimeoutError':    'הזמן הסתיים',
    'bookingPermissionError': 'אין הרשאה לעדכן...',
    // ── Booking Status Badges ────────────────────────────────────────────────
    'statusPendingCompletion': 'ממתין לסיום',
    'statusPendingApproval':  'ממתין לאישור',
    'statusCompleted':        'הושלם',
    'statusCancelled':        'בוטל',
    'statusDisputed':         'במחלוקת',
    'statusSplitResolved':    'נפתר — פשרה',
    'statusCancelledWithPenalty': 'בוטל (קנס)',
    'statusBadgeEscrow':      'בנאמנות',
    'statusBadgePending':     'ממתין לאישור',
    'statusBadgeCompleted':   'הושלם',
    'statusBadgeCancelled':   'בוטל',
    'statusBadgeCancelledPenalty': 'בוטל+קנס',
    'statusBadgeDisputed':    'במחלוקת',
    'statusBadgeRefunded':    'הוחזר',
    'statusBadgeSplit':       'פשרה',
    'statusBadgeInProgress':  'בטיפול',
    // ── Opportunities ────────────────────────────────────────────────────────
    'oppSortNearest':         '📍 הכי קרוב',
    'oppSortMostProfitable':  '💰 הכי רווחי',
    'oppSortUrgent':          '🔥 דחוף',
    'oppNearbyBadge':         '🔥 קרוב אליך',
    'oppViewOnMap':           'צפה במיקום על המפה',
    'oppViewersCounter':      '{viewers} מומחים נוספים בוחנים את ההצעה',
    'aiCoachCtaTitle':        '🤖 ניתוח AI — איך להשיג יותר עבודות?',
    'aiCoachCtaSubtitle':     'הקש לניתוח חינמי של הפרופיל שלך',
    'aiCoachLoadingText':     'מנתח את הפרופיל שלך...',
    'aiCoachRefreshButton':   'רענן ניתוח',
    'aiCoachUpdatedAgo':      'עודכן לפני {time}',
  },
  ...
  'en': {
    ...
    // ── Home Tab (New Keys) ─────────────────────────────────────────────────
    'homeCategoryNotFound':   'No category found for "{query}"',
    'homeCategoryCount':      '{count} categories',
    'homeShowAll':            'Show All',
    'homeCommunityButton':    'For the Community',
    'homeUrgentSearch':       'Urgent Search',
    'reengagementDefaultMessage': 'Ready to book again?',
    'reengagementBadgeLabel': 'Smart Offer',
    'reengagementCtaButton':  'Book Now',
    'bannerWelcomeTitle':     'Welcome to AnySkill',
    'bannerWelcomeSubtitle':  'Find experts from your neighborhood',
    'bannerProfessionalTitle': 'Professional service at a single tap',
    'bannerProfessionalSubtitle': 'Repairs • Cleaning • Photography and more',
    'bannerBecomeExpertTitle': 'Become an expert today',
    'bannerBecomeExpertSubtitle': 'Post your service and start earning',
    'adminEmailTestSent':     'Test email sent! Check your inbox.',
    'defaultExpertName':      'Expert',
    // ── Search Bar & Filters ────────────────────────────────────────────────
    'searchBarHint':          'What would you like to do today?',
    'searchFilterPlumber':    'Plumber',
    'searchFilterElectrician': 'Electrician',
    'searchFilterCleaning':   'Cleaning',
    'searchFilterGardening':  'Gardening',
    'searchFilterPrivateLessons': 'Private Lessons',
    'searchFilterBusinessConsulting': 'Business Consulting',
    'searchFilterDesign':     'Design',
    'searchFilterTranslation': 'Translation',
    'searchFilterMassage':    'Massage',
    'searchFilterFitness':    'Fitness & Training',
    'searchFilterBeauty':     'Beauty',
    'searchFilterNutrition':  'Nutrition',
    'searchFilterMusic':      'Music',
    'searchFilterPainting':   'Painting',
    'searchFilterWriting':    'Writing',
    'searchFilterCoding':     'Coding',
    // ── Expert Card & Stories ──────────────────────────────────────────────
    'expertCardLiveStoryBadge': 'Live Story',
    'storiesRowSectionTitle': 'Stories from Providers',
    'storiesRowActiveCount':  '{count} active',
    'storiesMyStoryLabel':    'My Story',
    'storiesAddStoryLabel':   'Add Story',
    'storiesDefaultProviderName': 'Me',
    'defaultProviderName':    'Provider',
    'storiesTimeRemainingHours': '{hours}h',
    'storiesTimeRemainingMinutes': '{minutes}m',
    'storiesDeleteDialogTitle': 'Delete this story?',
    'storiesDeleteDialogBody': 'The story will be permanently deleted and cannot be recovered.',
    'storiesDeleteConfirmButton': 'Delete',
    'storiesDeletedSnackbar':  'Story deleted successfully 🗑️',
    'storiesLikeNotificationTitle': '❤️ Like on {name}\'s story',
    'storiesQuickReplyAvailability': 'Are you available in my area?',
    'storiesQuickReplyCost': 'What\'s the price for a visit?',
    'storiesQuickReplySendPhoto': 'Can you send a photo of the issue?',
    'storiesLoadError':       'Failed to load story',
    'storiesAvailableNow':    'Available Now',
    'storiesBookOrMessageButton': 'Book Now / Send Message',
    'storiesViewFullProfileLink': 'View full profile and pricing →',
    'storiesUploadSourceTitle': 'Choose source',
    'storiesUploadGalleryLabel': 'Gallery',
    'storiesUploadGallerySub': 'Pick an existing video',
    'storiesUploadCameraLabel': 'Camera',
    'storiesUploadCameraSub': 'Shoot now',
    'storiesNewStoryNotificationTitle': '📱 New story: {name}',
    'storiesNewStoryNotificationDetail': 'Service: {service}',
    'storiesPublishedSnackbar': 'Your story is live! ✨ Valid for 24 hours',
    'storiesUploadErrorPermission': 'Permission error — try logging in again',
    'storiesUploadCancelled': 'Upload cancelled',
    'storiesUploadErrorNetwork': 'Network error — check your connection and try again',
    'storiesUploadErrorGeneric': 'Upload failed — try again',
    'storiesUploadPanelTitle': 'Skills Story',
    'storiesUploadPanelSubtitle': 'Showcase your talent • Valid for 24 hours',
    'storiesPerkSearchBoost': 'Search Boost',
    'storiesPerk24Hours':     '24 Hours',
    'storiesSelectVideoButton': 'Select video from gallery',
    'storiesVideoRecommendedLength': 'Recommended up to 60 seconds',
    'storiesReplaceVideoButton': 'Replace Video',
    'storiesUploadingProgress': 'Uploading... {percent}%',
    'storiesPreparingUpload': 'Preparing...',
    'storiesPublishButton':   'Publish Story',
    // ── Bookings & Orders ────────────────────────────────────────────────────
    'bookingsAppBarExpert':   'My Jobs',
    'bookingsAppBarCustomer': 'My Bookings',
    'bookingsTabCalendar':    'Calendar',
    'bookingsTabMyTasks':     'My Tasks',
    'bookingsTabActive':      'Active',
    'bookingsTabHistory':     'History',
    'bookingsAvailabilityTitle': 'Manage Availability',
    'bookingsAvailabilityHint': 'Tap a date to select. Long-press to block/unblock.',
    'bookingsCalendarBlocked': 'Blocked',
    'bookingsCalendarBooking': 'Booking',
    'calendarFormatMonth':    'Month',
    'bookingsBlockedDatesLabel': 'Blocked dates:',
    'bookingsSaveBlockedDates': 'Save Blocks',
    'bookingDetailsTitle':    'Booking Details',
    'bookingDetailId':        'Booking ID',
    'bookingDetailExpert':    'Expert',
    'bookingDetailCustomer':  'Customer',
    'bookingDetailStatus':    'Status',
    'bookingDetailAmount':    'Amount',
    'bookingDetailDate':      'Date',
    'bookingDetailTime':      'Time',
    'bookingCancelDialogTitle': 'Cancel Booking',
    'bookingCancelPenaltyWarning': 'Warning: Free cancellation window has passed...',
    'bookingCancelConfirmMessage': 'Cancel this booking? ₪{amount} will be refunded to your wallet.',
    'bookingCancelRefundBreakdown': 'You get back: ₪{customer}\nExpert receives: ₪{expert}',
    'bookingCancelYesPenalty': 'Yes, cancel (penalty ₪{penalty})',
    'bookingCancelYes':       'Yes, cancel',
    'bookingCancelledRefundSnackbar': 'Booking cancelled — ₪{amount} refunded to your wallet',
    'bookingErrorCancelling': 'Error cancelling: {error}',
    'bookingProviderCancelTitle': 'Provider cancellation',
    'bookingProviderCancelMessage': 'Provider cancellation refunds customer 100%...',
    'bookingProviderCancelledSnackbar': 'Booking cancelled — customer will receive full refund',
    'bookingTipDialogTitle': 'Send Tip',
    'bookingTipConfirmMessage': 'Send ₪{amount} tip to {expert}?',
    'bookingTipSendButton':   'Send',
    'bookingTipSentSnackbar': '₪{amount} sent to {expert} 🎉',
    'bookingTipErrorSnackbar': 'Error sending tip: {error}',
    'bookingReviewPromptTitle': 'How was the service?',
    'bookingSubmitReviewButton': 'Submit Review ⭐',
    'bookingReviewSentConfirmation': 'Review submitted — Thank you!',
    'bookingReceiptChip':     'Receipt',
    'bookingAmountEscrow':    'Escrow',
    'bookingAmountLabel':     'Amount',
    'bookingReleasePaymentButton': 'Confirm & Release Payment',
    'bookingOpenDisputeButton': 'Something\'s wrong — Open Dispute',
    'bookingCancelButton':    'Cancel Booking',
    'bookingTipLabel':        'Send Tip:',
    'bookingExpertOnTheWay':  'Expert is on the way',
    'bookingViewExpertOnMap': 'View expert on map 📍',
    'bookingWorkStartedMinutesAgo': 'Work started {minutes} minutes ago',
    'bookingRebookButton':    'Rebook {expert}',
    'bookingCallExpertButton': '📞 Call Expert',
    'bookingQuickChatButton': '💬 Quick Chat',
    'bookingDetailsFooter':   'Booking Details',
    'bookingStepReceived':    'Received',
    'bookingStepOnTheWay':    'On the way',
    'bookingStepInProgress':  'In progress',
    'bookingStepDone':        'Done',
    'bookingNavigateButton':  'Navigate to Job 🚗',
    'bookingStartWorkButton': 'Arrived — Start Work 🛠️',
    'bookingMarkDoneButton':  'Mark as Complete',
    'bookingChatWithCustomerButton': 'Chat with Customer',
    'bookingWaitingForClientApproval': 'Waiting for client approval',
    'bookingShowReceiptButton': 'Show Receipt',
    'bookingShareReviewButton': 'Share Review ⭐',
    'bookingReviewWindowExpired': 'Review window expired (7 days)',
    'bookingsEarningsSummaryLabel': 'Total Expected Earnings',
    'bookingsActiveCountLabel': 'Bookings',
    'bookingLoadError':       'Unable to load bookings right now. Please try again.',
    'bookingsEmptyExpertTitle': 'No tasks yet',
    'bookingsEmptyHistoryTitle': 'No booking history',
    'bookingsEmptyCustomerTitle': 'Have a task? We have the right person for it.',
    'bookingsEmptyExpertSubtitle': 'Customer bookings will appear here. Make sure your profile is up to date.',
    'bookingsEmptyHistorySubtitle': 'Completed bookings will appear here.',
    'bookingsEmptyCustomerSubtitle': 'Don\'t settle for less than the best. Let\'s get started?',
    'bookingsEmptyCtaButton': 'Book Service Now',
    'bookingsGroupActive':    'Active',
    'bookingsGroupHistory':   'History',
    'bookingsGroupThisMonth': 'This Month',
    'bookingsGroupLastMonth': 'Last Month',
    'bookingsGroupOlder':     'Older',
    'bookingExpertCompletedMessage': '✅ Expert completed the work! Tap "Confirm & Release"...',
    'bookingErrorSaving':     'Error saving: {error}',
    'defaultCustomerName':    'Customer',
    'bookingStatusUpdateFailed': 'Status not updated — try again (status: {status})',
    'bookingTimeoutError':    'Timeout',
    'bookingPermissionError': 'No permission to update...',
    // ── Booking Status Badges ────────────────────────────────────────────────
    'statusPendingCompletion': 'Waiting for Completion',
    'statusPendingApproval':  'Waiting for Approval',
    'statusCompleted':        'Completed',
    'statusCancelled':        'Cancelled',
    'statusDisputed':         'Disputed',
    'statusSplitResolved':    'Resolved — Split',
    'statusCancelledWithPenalty': 'Cancelled (Penalty)',
    'statusBadgeEscrow':      'Escrow',
    'statusBadgePending':     'Waiting for Approval',
    'statusBadgeCompleted':   'Completed',
    'statusBadgeCancelled':   'Cancelled',
    'statusBadgeCancelledPenalty': 'Cancelled+Penalty',
    'statusBadgeDisputed':    'Disputed',
    'statusBadgeRefunded':    'Refunded',
    'statusBadgeSplit':       'Split',
    'statusBadgeInProgress':  'In Progress',
    // ── Opportunities ────────────────────────────────────────────────────────
    'oppSortNearest':         '📍 Closest',
    'oppSortMostProfitable':  '💰 Most Profitable',
    'oppSortUrgent':          '🔥 Urgent',
    'oppNearbyBadge':         '🔥 Near You',
    'oppViewOnMap':           'View location on map',
    'oppViewersCounter':      '{viewers} more experts are viewing this request',
    'aiCoachCtaTitle':        '🤖 AI Analysis — Get More Jobs?',
    'aiCoachCtaSubtitle':     'Tap for free profile analysis',
    'aiCoachLoadingText':     'Analyzing your profile...',
    'aiCoachRefreshButton':   'Refresh Analysis',
    'aiCoachUpdatedAgo':      'Updated {time} ago',
  },
  ...
  'es': {
    ...
    // ── Home Tab (New Keys) ─────────────────────────────────────────────────
    'homeCategoryNotFound':   'No se encontró categoría para "{query}"',
    'homeCategoryCount':      '{count} categorías',
    'homeShowAll':            'Ver Todos',
    'homeCommunityButton':    'Para la Comunidad',
    'homeUrgentSearch':       'Búsqueda Urgente',
    'reengagementDefaultMessage': '¿Listo para reservar de nuevo?',
    'reengagementBadgeLabel': 'Oferta Inteligente',
    'reengagementCtaButton':  'Reservar Ahora',
    'bannerWelcomeTitle':     'Bienvenido a AnySkill',
    'bannerWelcomeSubtitle':  'Encuentra expertos en tu vecindario',
    'bannerProfessionalTitle': 'Servicio profesional en un solo toque',
    'bannerProfessionalSubtitle': 'Reparaciones • Limpieza • Fotografía y más',
    'bannerBecomeExpertTitle': 'Conviértete en experto hoy',
    'bannerBecomeExpertSubtitle': 'Publica tu servicio y comienza a ganar',
    'adminEmailTestSent':     '¡Correo de prueba enviado! Verifica tu bandeja.',
    'defaultExpertName':      'Experto',
    // ── Search Bar & Filters ────────────────────────────────────────────────
    'searchBarHint':          '¿Qué te gustaría hacer hoy?',
    'searchFilterPlumber':    'Plomero',
    'searchFilterElectrician': 'Electricista',
    'searchFilterCleaning':   'Limpieza',
    'searchFilterGardening':  'Jardinería',
    'searchFilterPrivateLessons': 'Lecciones Privadas',
    'searchFilterBusinessConsulting': 'Consultoría Empresarial',
    'searchFilterDesign':     'Diseño',
    'searchFilterTranslation': 'Traducción',
    'searchFilterMassage':    'Masaje',
    'searchFilterFitness':    'Fitness y Entrenamiento',
    'searchFilterBeauty':     'Belleza',
    'searchFilterNutrition':  'Nutrición',
    'searchFilterMusic':      'Música',
    'searchFilterPainting':   'Pintura',
    'searchFilterWriting':    'Escritura',
    'searchFilterCoding':     'Programación',
    // ── Expert Card & Stories ──────────────────────────────────────────────
    'expertCardLiveStoryBadge': 'Historia en Vivo',
    'storiesRowSectionTitle': 'Historias de Proveedores',
    'storiesRowActiveCount':  '{count} activo{isPlural}',
    'storiesMyStoryLabel':    'Mi Historia',
    'storiesAddStoryLabel':   'Agregar Historia',
    'storiesDefaultProviderName': 'Yo',
    'defaultProviderName':    'Proveedor',
    'storiesTimeRemainingHours': '{hours}h',
    'storiesTimeRemainingMinutes': '{minutes}m',
    'storiesDeleteDialogTitle': '¿Eliminar esta historia?',
    'storiesDeleteDialogBody': 'La historia se eliminará permanentemente y no se puede recuperar.',
    'storiesDeleteConfirmButton': 'Eliminar',
    'storiesDeletedSnackbar':  'Historia eliminada con éxito 🗑️',
    'storiesLikeNotificationTitle': '❤️ Me gusta en la historia de {name}',
    'storiesQuickReplyAvailability': '¿Estás disponible en mi área?',
    'storiesQuickReplyCost': '¿Cuál es el precio de una visita?',
    'storiesQuickReplySendPhoto': '¿Puedes enviar una foto del problema?',
    'storiesLoadError':       'No se pudo cargar la historia',
    'storiesAvailableNow':    'Disponible Ahora',
    'storiesBookOrMessageButton': 'Reservar Ahora / Enviar Mensaje',
    'storiesViewFullProfileLink': 'Ver perfil completo y precios →',
    'storiesUploadSourceTitle': 'Elige fuente',
    'storiesUploadGalleryLabel': 'Galería',
    'storiesUploadGallerySub': 'Selecciona un video existente',
    'storiesUploadCameraLabel': 'Cámara',
    'storiesUploadCameraSub': 'Graba ahora',
    'storiesNewStoryNotificationTitle': '📱 Nueva historia: {name}',
    'storiesNewStoryNotificationDetail': 'Servicio: {service}',
    'storiesPublishedSnackbar': '¡Tu historia está en vivo! ✨ Válida por 24 horas',
    'storiesUploadErrorPermission': 'Error de permiso — intenta iniciar sesión nuevamente',
    'storiesUploadCancelled': 'Carga cancelada',
    'storiesUploadErrorNetwork': 'Error de red — verifica tu conexión e intenta de nuevo',
    'storiesUploadErrorGeneric': 'Error de carga — intenta de nuevo',
    'storiesUploadPanelTitle': 'Historia de Habilidades',
    'storiesUploadPanelSubtitle': 'Muestra tu talento • Válida por 24 horas',
    'storiesPerkSearchBoost': 'Impulso de Búsqueda',
    'storiesPerk24Hours':     '24 Horas',
    'storiesSelectVideoButton': 'Selecciona video de la galería',
    'storiesVideoRecommendedLength': 'Recomendado hasta 60 segundos',
    'storiesReplaceVideoButton': 'Reemplazar Video',
    'storiesUploadingProgress': 'Cargando... {percent}%',
    'storiesPreparingUpload': 'Preparando...',
    'storiesPublishButton':   'Publicar Historia',
    // ── Bookings & Orders ────────────────────────────────────────────────────
    'bookingsAppBarExpert':   'Mis Trabajos',
    'bookingsAppBarCustomer': 'Mis Reservas',
    'bookingsTabCalendar':    'Calendario',
    'bookingsTabMyTasks':     'Mis Tareas',
    'bookingsTabActive':      'Activo',
    'bookingsTabHistory':     'Historial',
    'bookingsAvailabilityTitle': 'Gestionar Disponibilidad',
    'bookingsAvailabilityHint': 'Toca una fecha para seleccionar. Mantén presionado para bloquear/desbloquear.',
    'bookingsCalendarBlocked': 'Bloqueado',
    'bookingsCalendarBooking': 'Reserva',
    'calendarFormatMonth':    'Mes',
    'bookingsBlockedDatesLabel': 'Fechas bloqueadas:',
    'bookingsSaveBlockedDates': 'Guardar Bloqueos',
    'bookingDetailsTitle':    'Detalles de la Reserva',
    'bookingDetailId':        'ID de Reserva',
    'bookingDetailExpert':    'Experto',
    'bookingDetailCustomer':  'Cliente',
    'bookingDetailStatus':    'Estado',
    'bookingDetailAmount':    'Monto',
    'bookingDetailDate':      'Fecha',
    'bookingDetailTime':      'Hora',
    'bookingCancelDialogTitle': 'Cancelar Reserva',
    'bookingCancelPenaltyWarning': 'Advertencia: La ventana de cancelación gratuita ha pasado...',
    'bookingCancelConfirmMessage': '¿Cancelar esta reserva? ₪{amount} se reembolsarán a tu billetera.',
    'bookingCancelRefundBreakdown': 'Recuperas: ₪{customer}\nExperto recibe: ₪{expert}',
    'bookingCancelYesPenalty': 'Sí, cancelar (penalización ₪{penalty})',
    'bookingCancelYes':       'Sí, cancelar',
    'bookingCancelledRefundSnackbar': 'Reserva cancelada — ₪{amount} reembolsado a tu billetera',
    'bookingErrorCancelling': 'Error al cancelar: {error}',
    'bookingProviderCancelTitle': 'Cancelación del proveedor',
    'bookingProviderCancelMessage': 'La cancelación del proveedor reembolsa al cliente 100%...',
    'bookingProviderCancelledSnackbar': 'Reserva cancelada — el cliente recibirá reembolso completo',
    'bookingTipDialogTitle': 'Enviar Propina',
    'bookingTipConfirmMessage': '¿Enviar propina de ₪{amount} a {expert}?',
    'bookingTipSendButton':   'Enviar',
    'bookingTipSentSnackbar': '₪{amount} enviados a {expert} 🎉',
    'bookingTipErrorSnackbar': 'Error al enviar propina: {error}',
    'bookingReviewPromptTitle': '¿Cómo fue el servicio?',
    'bookingSubmitReviewButton': 'Enviar Reseña ⭐',
    'bookingReviewSentConfirmation': 'Reseña enviada — ¡Gracias!',
    'bookingReceiptChip':     'Recepción',
    'bookingAmountEscrow':    'Depósito en Garantía',
    'bookingAmountLabel':     'Monto',
    'bookingReleasePaymentButton': 'Confirmar y Liberar Pago',
    'bookingOpenDisputeButton': 'Algo anda mal — Abrir Disputa',
    'bookingCancelButton':    'Cancelar Reserva',
    'bookingTipLabel':        'Enviar Propina:',
    'bookingExpertOnTheWay':  'El experto está en camino',
    'bookingViewExpertOnMap': 'Ver experto en mapa 📍',
    'bookingWorkStartedMinutesAgo': 'El trabajo comenzó hace {minutes} minutos',
    'bookingRebookButton':    'Reservar de nuevo a {expert}',
    'bookingCallExpertButton': '📞 Llamar Experto',
    'bookingQuickChatButton': '💬 Chat Rápido',
    'bookingDetailsFooter':   'Detalles de la Reserva',
    'bookingStepReceived':    'Recibido',
    'bookingStepOnTheWay':    'En camino',
    'bookingStepInProgress':  'En progreso',
    'bookingStepDone':        'Hecho',
    'bookingNavigateButton':  'Navegar al Trabajo 🚗',
    'bookingStartWorkButton': 'Llegué — Comienza el Trabajo 🛠️',
    'bookingMarkDoneButton':  'Marcar como Completado',
    'bookingChatWithCustomerButton': 'Chat con Cliente',
    'bookingWaitingForClientApproval': 'Esperando aprobación del cliente',
    'bookingShowReceiptButton': 'Mostrar Recepción',
    'bookingShareReviewButton': 'Compartir Reseña ⭐',
    'bookingReviewWindowExpired': 'Ventana de reseña expirada (7 días)',
    'bookingsEarningsSummaryLabel': 'Ganancias Esperadas Totales',
    'bookingsActiveCountLabel': 'Reservas',
    'bookingLoadError':       'No se pueden cargar las reservas ahora. Por favor intenta de nuevo.',
    'bookingsEmptyExpertTitle': 'Sin tareas aún',
    'bookingsEmptyHistoryTitle': 'Sin historial de reservas',
    'bookingsEmptyCustomerTitle': '¿Tienes una tarea? Tenemos a la persona correcta para ti.',
    'bookingsEmptyExpertSubtitle': 'Las reservas del cliente aparecerán aquí. Asegúrate de que tu perfil esté actualizado.',
    'bookingsEmptyHistorySubtitle': 'Las reservas completadas aparecerán aquí.',
    'bookingsEmptyCustomerSubtitle': 'No te conformes con menos que lo mejor. ¿Vamos?',
    'bookingsEmptyCtaButton': 'Reservar Servicio Ahora',
    'bookingsGroupActive':    'Activo',
    'bookingsGroupHistory':   'Historial',
    'bookingsGroupThisMonth': 'Este Mes',
    'bookingsGroupLastMonth': 'Mes Pasado',
    'bookingsGroupOlder':     'Más Antiguo',
    'bookingExpertCompletedMessage': '✅ El experto completó el trabajo. Toca "Confirmar y Liberar"...',
    'bookingErrorSaving':     'Error al guardar: {error}',
    'defaultCustomerName':    'Cliente',
    'bookingStatusUpdateFailed': 'Estado no actualizado — intenta de nuevo (estado: {status})',
    'bookingTimeoutError':    'Tiempo agotado',
    'bookingPermissionError': 'Sin permiso para actualizar...',
    // ── Booking Status Badges ────────────────────────────────────────────────
    'statusPendingCompletion': 'Esperando Finalización',
    'statusPendingApproval':  'Esperando Aprobación',
    'statusCompleted':        'Completado',
    'statusCancelled':        'Cancelado',
    'statusDisputed':         'Disputado',
    'statusSplitResolved':    'Resuelto — Dividido',
    'statusCancelledWithPenalty': 'Cancelado (Penalización)',
    'statusBadgeEscrow':      'Depósito en Garantía',
    'statusBadgePending':     'Esperando Aprobación',
    'statusBadgeCompleted':   'Completado',
    'statusBadgeCancelled':   'Cancelado',
    'statusBadgeCancelledPenalty': 'Cancelado+Penalización',
    'statusBadgeDisputed':    'Disputado',
    'statusBadgeRefunded':    'Reembolsado',
    'statusBadgeSplit':       'Dividido',
    'statusBadgeInProgress':  'En Progreso',
    // ── Opportunities ────────────────────────────────────────────────────────
    'oppSortNearest':         '📍 Más Cercano',
    'oppSortMostProfitable':  '💰 Más Rentable',
    'oppSortUrgent':          '🔥 Urgente',
    'oppNearbyBadge':         '🔥 Cerca de Ti',
    'oppViewOnMap':           'Ver ubicación en mapa',
    'oppViewersCounter':      '{viewers} expertos más están viendo esta solicitud',
    'aiCoachCtaTitle':        '🤖 Análisis IA — ¿Obtener Más Trabajos?',
    'aiCoachCtaSubtitle':     'Toca para análisis gratuito del perfil',
    'aiCoachLoadingText':     'Analizando tu perfil...',
    'aiCoachRefreshButton':   'Actualizar Análisis',
    'aiCoachUpdatedAgo':      'Actualizado hace {time}',
  },
  // ─────────────────────────────────────────────── ARABIC ───────────────────
  'ar': {
    // App
    'appName':                'AnySkill',
    'appSlogan':              'AnySkill — موهبتك، خدمتهم',
    // Navigation
    'tabHome':                'الرئيسية',
    ...
    'currencySymbol':         '₪',
    // ── App-level banners ─────────────────────────────────────────────────
    'updateBannerText':       'قمنا بتحديث AnySkill من أجلك!\nإصدار جديد متاح لتحسين الأداء 🚀',
    'updateNowButton':        'حدّث الآن',
    'notifOpen':              'فتح',
    // ── Auth / Login ──────────────────────────────────────────────────────
    'loginTitle':             'مرحباً بكم في AnySkill',
    'loginAccountTitle':      'تسجيل الدخول',
    'loginWelcomeBack':       'مرحباً بعودتكم! الخبراء بانتظاركم',
    ...
    'loginSignUpFree':        'سجّل مجاناً الآن',
    'loginOrWith':            'أو سجّل الدخول عبر',
    'loginAppleComingSoon':   'تسجيل الدخول عبر Apple سيكون متاحاً قريباً',
    'loginStats10k':          'محترفون',
    'loginStats50':           'فئات',
    'loginStats49':           'تقييم',
    // Auth errors
    'errorUserNotFound':      'لم يتم العثور على مستخدم بهذا البريد الإلكتروني',
    'errorWrongPassword':     'كلمة المرور خاطئة — حاول مجدداً',
    'errorInvalidCredential': 'البريد الإلكتروني أو كلمة المرور غير صحيحة',
    'errorInvalidEmail':      'عنوان البريد الإلكتروني غير صالح',
    'errorUserDisabled':      'تم تعطيل هذا الحساب',
    'errorTooManyRequests':   'محاولات كثيرة جداً — حاول مجدداً بعد بضع دقائق',
    'errorNetworkFailed':     'خطأ في الشبكة — تحقق من الاتصال',
    'errorGenericLogin':      'خطأ في تسجيل الدخول، حاول مجدداً',
    'errorEmptyFields':       'يرجى إدخال البريد الإلكتروني وكلمة المرور',
    'errorGoogleLogin':       'خطأ في تسجيل الدخول عبر Google',
    // Forgot password
    ...
    'forgotPasswordSuccess':  'تم إرسال رابط إعادة التعيين إلى بريدك الإلكتروني ✉️',
    'forgotPasswordError':    'خطأ — تحقق من أن البريد الإلكتروني مسجّل في النظام',
    // Sign-up
    'signupButton':           'تسجيل',
    'signupTitle':            'الانضمام إلى AnySkill',
    'googleNewUserBio':       'عميل جديد في AnySkill',
    // Validation
    'validationNameRequired': 'يرجى إدخال الاسم',
    'validationNameLength':   'يجب أن يحتوي الاسم على حرفين على الأقل',
    'validationRoleRequired': 'يجب اختيار دور واحد على الأقل',
    'validationCategoryRequired': 'يرجى اختيار مجال التخصص',
    'validationPriceInvalid': 'يجب أن يكون السعر رقماً صالحاً',
    'validationPricePositive':'يجب أن يكون السعر أكبر من 0',
    'validationNameForbidden':    'يحتوي الاسم على أحرف محظورة (HTML/سكريبت)',
    'validationNameTooLong':      'الاسم طويل جداً (الحد الأقصى 50 حرفاً)',
    'validationAboutForbidden':   'يحتوي الوصف على أحرف محظورة (HTML/سكريبت)',
    'validationAboutTooLong':     'الوصف طويل جداً (الحد الأقصى 500 حرف)',
    'validationUrlHttps':         'يجب أن يبدأ العنوان بـ https://',
    'validationFieldForbidden':   'يحتوي الحقل على أحرف محظورة',
    // ── Profile ────────────────────────────────────────────────────────────
    'profileTitle':           'ملفي الشخصي',
    'shareProfileTitle':      'شارك ملفك الشخصي لزيادة المبيعات',
    'shareProfileWhatsapp':   'أرسل مباشرة عبر واتساب',
    'shareProfileCopyLink':   'انسخ رابط الملف الشخصي',
    'shareProfileTooltip':    'مشاركة الملف الشخصي',
    'linkCopied':             'تم نسخ الرابط! الصقه أينما تريد.',
    'whatsappError':          'تعذّر فتح واتساب في هذا المتصفح',
    'defaultUserName':        'مستخدم مجهول',
    'logoutTooltip':          'تسجيل الخروج',
    'logoutTitle':            'تسجيل الخروج',
    'logoutContent':          'هل أنت متأكد أنك تريد تسجيل الخروج؟',
    'logoutConfirm':          'تسجيل الخروج',
    'logoutButton':           'تسجيل الخروج من النظام',
    'aboutMeTitle':           'نبذة عني',
    'aboutMePlaceholder':     'لم يُكتب وصف بعد.',
    'galleryTitle':           'معرض الأعمال',
    'galleryEmpty':           'لا توجد صور في المعرض',
    'statRating':             'التقييم',
    'statBalance':            'الرصيد',
    'statWorks':              'الأعمال',
    'bookingsTrackerButton':  'لمتابعة حجوزاتي',
    'bookingsTrackerSnackbar':'الانتقال إلى المحادثات لمتابعة الصفقات...',
    // VIP
    'vipActiveLabel':         'VIP نشط',
    'vipExpiredLabel':        'منتهي الصلاحية',
    'vipHighlight':           'ملفك الشخصي يظهر أولاً في البحث مع توهّج ذهبي ✨',
    'vipUpsellTitle':         'ظهور مميز VIP',
    'vipBenefit1':            'تظهر أولاً في جميع نتائج البحث',
    'vipBenefit2':            'توهّج ذهبي وشارة "موصى به" على بطاقتك',
    'vipBenefit3':            'حتى 5 أضعاف مشاهدات للملف الشخصي',
    'vipBenefit4':            'أولوية في الطلبات العاجلة',
    'vipCtaButton':           'انضم إلى VIP — ₪99/شهر',
    'vipSheetHeader':         'انضم إلى VIP',
    'vipPriceMonthly':        '/شهر',
    'vipActivateButton':      '⭐ فعّل VIP — ₪99 من الرصيد',
    'vipInsufficientBalance': 'الرصيد غير كافٍ (مطلوب ₪99)',
    'vipInsufficientTooltip': 'اشحن محفظتك لتفعيل VIP',
    'vipActivationSuccess':   '🎉 مرحباً بك في VIP! ملفك الشخصي يظهر أولاً من الآن',
    // ── Language settings ─────────────────────────────────────────────────
    'languageTitle':          'اللغة',
    'languageHe':             'العبرية',
    ...
    'languageAr':             'العربية',
    'languageSectionLabel':   'لغة الواجهة',
    // ── Chat list ─────────────────────────────────────────────────────────
    'chatListTitle':          'الرسائل',
    'chatSearchHint':         'ابحث عن محادثة...',
    'chatEmptyState':         'لا توجد محادثات بعد',
    'chatUserDefault':        'مستخدم',
    'chatLastMessageDefault': 'رسالة جديدة',
    'markAllReadTooltip':     'تحديد الكل كمقروء',
    'markAllReadSuccess':     'تم تحديد جميع الرسائل كمقروءة',
    'deleteChatTitle':        'حذف المحادثة',
    'deleteChatContent':      'هل أنت متأكد أنك تريد حذف سجل المحادثة بالكامل؟',
    'deleteChatConfirm':      'حذف',
    'deleteChatSuccess':      'تم حذف المحادثة',
    'notLoggedIn':            'يرجى تسجيل الدخول مجدداً',
    // ── Search ────────────────────────────────────────────────────────────
    'searchPlaceholder':      'ابحث عن محترف، خدمة...',
    'searchTitle':            'البحث',
    'discoverCategories':     'اكتشف الفئات',
    'searchHintExperts':      'ماذا تريد أن تتعلم اليوم؟',
    'greetingMorning':        'صباح الخير',
    'greetingAfternoon':      'مساء الخير',
    'greetingEvening':        'مساء الخير',
    'greetingNight':          'ليلة سعيدة',
    'greetingSubMorning':     'ماذا تحتاج أن تنجز هذا الصباح؟',
    'greetingSubAfternoon':   'تبحث عن محترف؟ هذا هو الوقت المناسب',
    'greetingSubEvening':     'دلّل نفسك هذا المساء! تستحق ذلك',
    'greetingSubNight':       'اكتشف أبرز الخبراء',
    // ── Home tab ──────────────────────────────────────────────────────────
    'onlineStatus':           'متاح',
    'offlineStatus':          'غير متاح',
    'quickRequest':           'طلب سريع',
    'urgentJobBanner':        'هناك عمل جديد!',
    // ── Bookings ─────────────────────────────────────────────────────────
    'bookNow':                'احجز الآن',
    // ── Wallet ────────────────────────────────────────────────────────────
    'walletBalance':          'رصيد قابل للسحب',
    'walletMinWithdraw':      'الحد الأدنى للسحب: ₪50',
    'withdrawFunds':          'سحب الأموال',
    // ── ToS ──────────────────────────────────────────────────────────────
    'tosTitle':               'شروط الاستخدام',
    'tosAgree':               'قرأت وأوافق على الشروط',
    // ── Misc ──────────────────────────────────────────────────────────────
    'trendingBadge':          'رائج',
    'subCategoryPrompt':      'اختر التخصص',
    'reviewSubmit':           'إرسال التقييم',
    'urgentOpenButton':       'فتح',
    // ── Edit profile ──────────────────────────────────────────────────────
    'editProfileTitle':       'تعديل الملف الشخصي Elite',
    'saveSuccess':            'تم تحديث الملف الشخصي بنجاح!',
    'profileFieldName':       'الاسم الكامل',
    'profileFieldNameHint':   'كيف سيظهر اسمك في التطبيق؟',
    'profileFieldRole':       'تحديد الدور',
    'roleProvider':           'مقدّم خدمة',
    'roleCustomer':           'عميل',
    'profileFieldCategoryMain':     'مجال التخصص (رئيسي)',
    'profileFieldCategoryMainHint': 'اختر مجالاً',
    'profileFieldCategorySub':      'تخصص فرعي (فئة فرعية)',
    'profileFieldCategorySubHint':  'اختر تخصصاً',
    'profileFieldPrice':      'السعر بالساعة (₪)',
    'profileFieldPriceHint':  'كم تريد أن تربح؟',
    'profileFieldResponseTime':     'متوسط وقت الاستجابة',
    'profileFieldTaxId':      'رقم ضريبي / هوية (للفواتير)',
    'profileFieldTaxIdHint':  'مثال: 123456789',
    'profileFieldTaxIdHelp':  'سيظهر في الإيصالات الرقمية المرسلة للعملاء',
    'saveChanges':            'حفظ التغييرات',
    'saveError':              'خطأ في الحفظ: {error}',
    'profileFieldResponseTimeHint': 'كم من الوقت تستغرق عادةً للرد على الرسائل؟',
    'editProfileQuickTags':   'وسوم سريعة (Quick Tags)',
    'editProfileTagsSelected':'{count}/3 مختارة',
    'editProfileTagsHint':    'اختر حتى 3 وسوم ستظهر على بطاقتك',
    'editProfileCancellationPolicy': 'سياسة الإلغاء',
    'editProfileCancellationHint':   'سيرى العملاء هذه السياسة قبل إجراء الحجز',
    'editProfileAbout':       'الوصف الشخصي (نبذة)',
    'editProfileAboutHint':   'أخبرنا قليلاً عن خبرتك...',
    'editProfileGallery':     'معرض الأعمال (إثبات الكفاءة)',
    // ── Home tab ─────────────────────────────────────────────────────────────
    'homeProviderGreetingSub': 'ما الجديد في جدول أعمالك اليوم؟',
    'homeCustomerGreetingSub': 'ماذا تحتاج أن تنجز؟',
    'noCategoriesYet':        'لا توجد فئات بعد',
    'urgentBannerRequests':   'طلبات',
    'urgentBannerPending':    'قيد الانتظار',
    'urgentBannerCustomerWaiting': 'أنهى الخبير العمل — وافق لتحرير الدفعة 💚',
    'urgentBannerServiceNeeded':   'خدمة مطلوبة',
    'timeOneHour':            'ساعة',
    // ── Notifications ─────────────────────────────────────────────────────────
    'notificationsTitle':     'الإشعارات',
    'notifClearAll':          'مسح الكل',
    'notifEmptyTitle':        'لا توجد إشعارات بعد',
    'notifEmptySubtitle':     'ستظهر هنا الأنشطة المتعلقة بحسابك',
    'timeNow':                'الآن',
    'timeMinutesAgo':         'منذ {minutes} دقيقة',
    'timeHoursAgo':           'منذ {hours} ساعات',
    // ── Sign Up ───────────────────────────────────────────────────────────────
    'signupTosMustAgree':     'يجب الموافقة على شروط الاستخدام للمتابعة',
    'signupAccountCreated':   'تم إنشاء الحساب! مرحباً بك في AnySkill 🎉',
    'signupEmailInUse':       'عنوان البريد الإلكتروني مسجّل بالفعل في النظام',
    'signupWeakPassword':     'كلمة المرور ضعيفة جداً — جرّب كلمة مرور أقوى',
    'signupNetworkError':     'خطأ في الشبكة — تحقق من الاتصال بالإنترنت',
    'signupGenericError':     'خطأ في التسجيل',
    'signupNewProviderBio':   'خبير جديد في مجتمع AnySkill 🚀',
    'signupNewCustomerBio':   'عميل جديد في AnySkill',
    'signupIAmCustomer':      'أنا عميل',
    'signupIAmProvider':      'أنا مقدّم خدمة',
    'signupCustomerDesc':     'أبحث عن محترفين للمساعدة',
    'signupProviderDesc':     'أقدّم خدمات وأحقق أرباحاً',
    'signupName':             'الاسم الكامل',
    'signupNameHint':         'الاسم الذي سيظهر في ملفك الشخصي',
    'signupEmail':            'البريد الإلكتروني',
    'signupEmailHint':        'example@email.com',
    'signupPassword':         'كلمة المرور',
    'signupPasswordHint':     '8 أحرف على الأقل',
    'signupPhone':            'الهاتف (اختياري)',
    'signupPhoneHint':        '050-1234567',
    'signupCategory':         'مجال التخصص',
    'signupTosPrefix':        'قرأت وأوافق على ',
    'signupTosLink':          'شروط الاستخدام',
    'signupHaveAccount':      'لديك حساب بالفعل؟ ',
    'signupLogin':            'تسجيل الدخول',
    'signupOrWith':           'أو سجّل عبر',
    'signupGoogleError':      'خطأ في التسجيل عبر Google',
    'signupPasswordStrength0':'ضعيفة جداً',
    'signupPasswordStrength1':'ضعيفة',
    'signupPasswordStrength2':'متوسطة',
    'signupPasswordStrength3':'قوية',
    'signupPasswordStrength4':'قوية جداً',
    'signupNameValidation':   'الاسم مطلوب (حرفان على الأقل)',
    'signupEmailValidation':  'عنوان بريد إلكتروني غير صالح',
    'signupPasswordValidation':'6 أحرف على الأقل',
    'signupCategoryRequired': 'اختر مجالاً',
    // ── Bookings ──────────────────────────────────────────────────────────────
    'availabilityUpdated':    'تم تحديث التوفر بنجاح',
    'bookingCompleted':       'تم إنجاز العمل وتحرير الدفعة!',
    'releasePaymentError':    'خطأ في تحرير الدفعة',
    'markedDoneSuccess':      'تم التحديد كمكتمل! العميل سيوافق على تحرير الدفعة.',
    'cancelBookingTitle':     'إلغاء الحجز',
    'cancelPenaltyWarning':   'تحذير: انتهت فترة الإلغاء المجاني.\nوفقاً لسياسة {policy}، الإلغاء الآن سيترتب عليه غرامة بقيمة ₪{penalty}.',
    'cancelRefundBreakdown':  'ستسترد: ₪{refund}\nسيُدفع للخبير: ₪{penalty} (بعد خصم العمولة)',
    'cancelSimpleConfirm':    'هل تريد إلغاء الحجز?\n₪{amount} ستُعاد إلى محفظتك.',
    'noGoBack':               'لا، ارجع',
    'yesCancelWithPenalty':   'نعم، ألغِ (غرامة ₪{penalty})',
    'yesCancel':              'نعم، ألغِ',
    'bookingCancelledRefund': 'تم إلغاء الحجز — ₪{amount} أُعيدت إلى المحفظة',
    'cancelError':            'خطأ في الإلغاء: {error}',
    'providerCancelTitle':    'إلغاء من جهة مقدّم الخدمة',
    'providerCancelContent':  'الإلغاء من جهة مقدّم الخدمة يعيد للعميل 100% من المبلغ\nوسيخصم XP من ملفك الشخصي.\n\nهل تريد المتابعة؟',
    'providerCancelledSuccess':'تم إلغاء الحجز — سيحصل العميل على استرداد كامل',
    'disputeTitle':           'فتح نزاع',
    'disputeDescription':     'صف المشكلة المتعلقة بالخدمة المقدّمة. سيقوم فريقنا بالمراجعة واتخاذ القرار خلال 48 ساعة.',
    'disputeHint':            'صف المشكلة...',
    'submitDispute':          'إرسال النزاع',
    'jobTabActive':           'نشطة',
    'jobTabHistory':          'السجل',
    'jobTabCalendar':         'جدول التوفر',
    'bookingsTitle':          'حجوزاتي',
    'bookingsEmptyActive':    'لا توجد حجوزات نشطة حالياً',
    'bookingsEmptyHistory':   'لا توجد حجوزات في السجل',
    'jobStatusPaidEscrow':    'قيد التنفيذ',
    'jobStatusExpertCompleted':'بانتظار موافقتك',
    'jobStatusCompleted':     'مكتمل',
    'jobStatusCancelled':     'ملغى',
    'jobStatusDisputed':      'متنازع عليه',
    'saveAvailability':       'حفظ التوفر',
    'releasePayment':         'وافق وحرّر الدفعة',
    'markDone':               'حدّد كمكتمل',
    'openChat':               'فتح المحادثة',
    'openDispute':            'فتح نزاع',
    'cancelBooking':          'إلغاء الحجز',
    'ratingTitle':            'قيّم الخدمة',
    'ratingSubmit':           'إرسال التقييم',
    // ── Opportunities screen ───────────────────────────────────────────────────
    'oppTitle':               'لوحة الفرص',
    'oppAllCategories':       'جميع الفئات',
    'oppError':               'خطأ: {error}',
    'oppDefaultClient':       'عميل',
    'oppRequestUnavailable':  'الطلب لم يعد متاحاً',
    'oppRequestClosed3':      'الطلب مغلق — تم العثور على 3 مهتمين بالفعل',
    'oppAlreadyExpressed':    'لقد أبديت اهتمامك بهذا الطلب مسبقاً',
    'oppAlready3Interested':  'حصل الطلب على 3 مهتمين بالفعل',
    'oppInterestChatMessage': '💡 {providerName} أبدى اهتمامه بطلب الخدمة الخاص بك:\n"{description}"',
    'oppNotifTitle':          'مهتم جديد بطلبك!',
    'oppNotifBody':           '{providerName} يرغب في تقديم الخدمة التي طلبتها',
    'oppBoostEarned':         '🚀 ملفك الشخصي قفز إلى أعلى نتائج البحث لمدة 24 ساعة!',
    'oppInterestSuccess':     'أبديت اهتمامك! تم فتح المحادثة مع العميل',
    'oppQuickBidMessage':     'مرحباً {clientName}! 👋\nأنا {providerName} ومتاح لتقديم الخدمة التي طلبتها في أقرب وقت ممكن.\nما هو الوقت المناسب لك؟',
    'oppXpToNextLevel':       '{xp} XP أخرى للوصول إلى مستوى {name}',
    'oppMaxLevel':            'وصلت إلى أعلى مستوى! 🏆',
    'oppProfileBoosted':      '🚀 ملف شخصي مُعزَّز! حتى {time}',
    'oppBoostProgress':       'AnySkill Boost: {count}/3 — أكمل 3 مهام عاجلة',
    'oppTimeHours':           '{hours} ساعة',
    'oppTimeMinutes':         '{minutes} د',
    'oppTimeJustNow':         'الآن',
    'oppTimeMinAgo':          'قبل {minutes} د',
    'oppTimeHourAgo':         'قبل {hours} ساعة',
    'oppTimeDayAgo':          'قبل {days} أيام',
    'oppEmptyCategory':       'لا توجد فرص في مجالك حالياً',
    'oppEmptyAll':            'لا توجد طلبات مفتوحة حالياً',
    'oppEmptyCategorySubtitle': 'لا توجد فرص جديدة في مجالك حالياً،\nسنُعلمك عند توفرها 🔔',
    'oppEmptyAllSubtitle':    'طلبات جديدة من العملاء ستظهر هنا في الوقت الفعلي\nابقَ متيقظاً!',
    'oppHighDemand':          'طلب مرتفع',
    'oppViewersNow':          '{viewers} محترفاً يشاهدون هذه الفرصة الآن',
    'oppEstimatedEarnings':   'الربح الصافي المقدّر',
    'oppAfterFee':            'بعد عمولة AnySkill',
    'oppAlreadyInterested':   'أبديت اهتمامك ✓',
    'oppRequestClosedBtn':    'الطلب مُغلق',
    'oppTakeOpportunity':     'اغتنم الفرصة!',
    'oppInterested':          'أنا مهتم!',
    'oppQuickBid':            'رد سريع — أرسل عرضاً تلقائياً',
    'oppWalletHint':          'بعد إتمام العمل — سيتم تحويل أرباحك إلى محفظة AnySkill الخاصة بك',
    'helpCenterTooltip':          'مركز المساعدة',
    'searchTourSearchTitle':      '🔍 البحث عن خبراء',
    'searchTourSearchDesc':       'اكتب اسماً أو فئة أو نوع خدمة — AnySkill سيجد لك المزوّد المناسب',
    'searchTourSuggestionsTitle': '⚡ فئات مقترحة',
    'searchTourSuggestionsDesc':  'AnySkill يقترح خدمات حسب الوقت من اليوم — صباحاً للإصلاحات، مساءً للسبا والرفاهية',
    'searchTourFeedTitle':        '✨ فيد الإلهام',
    'searchTourFeedDesc':         'أعمال حقيقية من التطبيق — اضغط على البطاقة لعرض الملف الشخصي الكامل للمزوّد',
    'searchNoCategoriesBody':     'لم يتم العثور على فئات.\nقم بالتهيئة من لوحة الإدارة.',
    'searchNoResultsFor':         'لم يتم العثور على نتائج لـ "{query}"',
    'searchSectionCategories':    'الفئات',
    'searchSectionResultsFor':    'نتائج لـ "{query}"',
    'searchRecommendedBadge':     '⭐ موصى به',
    'searchPerHour':              ' / ساعة',
    'searchDatePickerHint':       'متى أنت متاح؟',
    'searchChipWeekend':          'متاح في عطلة نهاية الأسبوع',
    'searchChipHomeVisit':        'زيارة منزلية',
    'searchUrgencyMorning':       '🔴 بقي مكان واحد فقط لليوم!',
    'searchUrgencyAfternoon':     '⚡ بقي مكانان لهذا الأسبوع',
    'searchUrgencyEvening':       '⏰ عادةً يُحجز قبل 3 أيام',
    'searchDefaultExpert':        'خبير',
    'searchDefaultCity':          'منطقتك',
    'searchDefaultTitle':         'خبير معتمد',
    'editCategoryTitle':          'تعديل الفئة',
    'editCategoryChangePic':      'اضغط لتغيير الصورة',
    'editCategoryNameLabel':      'اسم الفئة',
    'editCategorySaveError':      'خطأ في الحفظ: {error}',
    'creditsLabel':               'أرصدة',
    'creditsDiscountAvailable':   'خصم {discount}% متاح!',
    'creditsToNextDiscount':      '{remaining} أخرى للخصم التالي',
    'inspirationFeedTitle':       'إلهام — أعمال مكتملة',
    'inspirationFeedNewBadge':    'جديد',
    'inspirationCompletedBadge':  'مكتمل ✓',
    'onlineToggleOn':             'اضغط لتكون متاحاً',
    'onlineToggleOff':            'اضغط لتكون غير متاح',
    'profileLoadError':           'خطأ في تحميل الملف الشخصي. يرجى المحاولة مرة أخرى.',
    'retryButton':                'أعد المحاولة',
    'bizAiLoading':               'جارٍ تحميل الذكاء التجاري...',
    'bizAiError':                 'خطأ: {error}',
    'bizAiTitle':                 'الذكاء التجاري',
    'bizAiSubtitle':              'اتجاهات السوق • AI • توقعات الإيرادات',
    'bizAiPending':               '{count} قيد الانتظار',
    'bizAiSectionAiOps':          'مركز AI',
    'bizAiActivityToday':         'نشاط AI اليوم',
    'bizAiNewCategories':         'فئات جديدة',
    'bizAiApprovalQueue':         'قائمة الموافقات',
    'bizAiTapToReview':           'اضغط للمراجعة ›',
    'bizAiModelAccuracy':         'دقة النموذج',
    'bizAiApprovedTotal':         'مُوافَق عليها / الإجمالي',
    'bizAiModelAccuracyDetail':   'تفاصيل دقة نموذج AI',
    'bizAiApproved':              'مُوافَق عليها',
    'bizAiRejected':              'مرفوضة',
    'bizAiPendingLabel':          'قيد الانتظار',
    'bizAiNoData':                'لا توجد بيانات AI بعد\nبعد تسجيل المزوّدين، ستظهر الإحصائيات هنا',
    'bizAiSectionMarket':         'طلب السوق',
    'bizAiPopularSearches':       '🔥 عمليات البحث الشائعة',
    'bizAiNoSearchData':          'لا توجد بيانات بحث بعد — سيظهر السجل بعد أن يبحث المستخدمون',
    'bizAiMarketOpportunities':   '🎯 فرص السوق (صفر نتائج)',
    'bizAiZeroResultsHint':       'عمليات بحث لم تجد مزوّدين — قم بتجنيد مزوّدين لهذه التخصصات',
    'bizAiNoOpportunities':       'لا توجد فرص معلقة — جميع عمليات البحث تجد مزوّدين 🎉',
    'bizAiSectionFinancial':      'رؤى مالية',
    'bizAiWeeklyForecast':        'توقعات العمولات الأسبوعية',
    'bizAiSevenDays':             '7 أيام',
    'bizAiActualToDate':          'الفعلي حتى الآن',
    'bizAiWeeklyProjection':      'التوقعات الأسبوعية',
    'bizAiLast7Days':             'إيرادات آخر 7 أيام',
    'bizAiDailyCommission':       'عمولة المنصة يوماً بيوم',
    'bizAiHighValueCategories':   'فئات ذات إيرادات عالية',
    'bizAiHighValueHint':         'السعر/ساعة × عدد الحجوزات حسب الفئة',
    'bizAiNoOrderData':           'لا توجد بيانات حجوزات بعد',
    'bizAiProviders':             '{count} مزوّدين',
    'bizAiRefreshData':           'تحديث البيانات',
    'bizAiThresholdUpdated':      'تم تحديث حد التنبيهات إلى {count} عملية بحث',
    'bizAiSectionAlerts':         'تنبيهات ذكية',
    'bizAiSearches':              '{count} عملية بحث',
    'bizAiAlertThreshold':        '🔔 حد تنبيه الطلب',
    'bizAiAlertThresholdHint':    'أرسل تنبيهاً عندما تتجاوز كلمة مفتاحية غير موجودة X مرة خلال 24 ساعة',
    'bizAiReset':                 'إعادة تعيين (5)',
    'bizAiSaveThreshold':         'حفظ الحد',
    'bizAiAlertHistory':          '📋 سجل التنبيهات',
    'bizAiNoAlerts':              'لا توجد تنبيهات بعد — ستظهر عندما تتجاوز الكلمات المفتاحية الحد المحدد',
    'bizAiAlertCount':            '{count}× تنبيهات',
    'bizAiSearchCount':           '{count} عملية بحث',
    'bizAiMinutesAgo':            'قبل {count} د',
    'bizAiHoursAgo':              'قبل {count} ساعة',
    'bizAiDaysAgo':               'قبل {count} أيام',
    'bizAiExecSummary':           'ملخص تنفيذي',
    'bizAiAccuracy':              'دقة AI',
    'bizAiCategoriesApproved':    'فئات تمت الموافقة عليها',
    'bizAiMarketOppsCard':        'فرص السوق',
    'bizAiNichesNoProviders':     'تخصصات بدون مزوّدين',
    'bizAiExpectedRevenue':       'الإيرادات المتوقعة',
    'bizAiForecastBadge':         'توقعات',
    'bizAiNoChartData':           'لا توجد بيانات عمولات للرسم البياني بعد\nستظهر بعد أول معاملة',
    'bizAiRecruitForQuery':       'جنّد مزوّدين لـ: "{query}"',
    'bizAiRecruitNow':            'جنّد الآن',
    'catResultsExpertDefault':    'خبير',
    'catResultsAvailableSlots':   'أقرب المواعيد المتاحة',
    'catResultsNoAvailability':   'لا يوجد توفر خلال الـ 14 يوماً القادمة',
    'catResultsFullBooking':      'للحجز الكامل',
    'catResultsOrderCount':       '🔥 {count} حجوزات',
    'catResultsResponseTime':     '⚡ يستجيب خلال {minutes} د',
    'catResultsTopRated':         '⭐ رائد',
    'catResultsAddPhoto':         'أضف\nصورة\nملف شخصي',
    'catResultsPerHour':          ' / ساعة',
    'catResultsRecommended':      'موصى به',
    'catResultsWhenFree':         'متى أنت متاح؟',
    'catResultsPageTitle':        'خبراء {category}',
    'catResultsSearchHint':       'ابحث بالاسم...',
    'catResultsUnder100':         'حتى 100 ₪',
    'catResultsLoadError':        'خطأ في تحميل الخبراء',
    'catResultsNoResults':        'لم يتم العثور على نتائج',
    'catResultsNoExperts':        'لا يوجد خبراء في {category} بعد',
    'catResultsNoResultsHint':    'حاول تغيير البحث أو إلغاء الفلتر',
    'catResultsBeFirst':          'كن أول من ينضم إلى هذه الفئة!',
    'catResultsClearFilters':     'مسح الفلاتر',
    'catResultsLoadMore':         'تحميل المزيد من الخبراء',
    'traitPunctual':             'دائماً في الموعد',
    'traitProfessional':         'محترف/ة',
    'traitCommunicative':        'تواصل ممتاز',
    'traitPatient':              'صبور/ة',
    'traitKnowledgeable':        'ذو/ذات معرفة',
    'traitFriendly':             'ودود/ة',
    'traitCreative':             'مبدع/ة',
    'traitFlexible':             'مرن/ة',
    'serviceSingleLesson':       'درس فردي',
    'serviceSingleSubtitle':     'جلسة شخصية واحدة',
    'serviceSingle60min':        '60 د',
    'serviceExtendedLesson':     'درس مطوّل',
    'serviceExtendedSubtitle':   'يشمل ملخصاً ومهام',
    'serviceExtended90min':      '90 د',
    'serviceFullSession':        'جلسة كاملة',
    'serviceFullSubtitle':       'عمل معمّق + خطة شخصية',
    'serviceFullSession120min':  '120 د',
    'expertInsufficientBalance': 'لا يوجد رصيد كافٍ في المحفظة لإتمام الحجز',
    'expertEscrowSuccess':       'تم حجز الموعد وإيداع الدفعة في الضمان!',
    'expertTransactionTitle':    'دفع آمن: {name}',
    'expertSystemMessage':       '🔒 حجز جديد بتاريخ {date} الساعة {time}!\nالمبلغ الذي سيُحوَّل إليك: ₪{amount}',
    'expertRecommendedBadge':    'موصى به',
    'expertStatRating':          'التقييم',
    'expertStatReviews':         'المراجعات',
    'expertStatRepeatClients':   'عملاء متكررون',
    'expertStatResponseTime':    'وقت الاستجابة',
    'expertStatOrders':          'الحجوزات',
    'expertStatXp':              'النقاط',
    'expertResponseTimeFormat':  '{minutes}د',
    'expertBioPlaceholder':      'خبير معتمد في مجتمع AnySkill.',
    'expertBioShowLess':         'عرض أقل ▲',
    'expertBioReadMore':         'اقرأ المزيد ▼',
    'expertSelectTime':          'اختر الوقت',
    'expertReviewsCount':        '{count} مراجعات',
    'expertReviewsHeader':       'المراجعات',
    'expertNoReviews':           'لا توجد مراجعات بعد',
    'expertDefaultReviewer':     'عميل',
    'expertVerifiedBooking':     'حجز آمن',
    'expertProviderResponse':    'رد المزوّد',
    'expertAddReply':            'أضف رداً',
    'expertAddReplyTitle':       'أضف رداً على المراجعة',
    'expertReplyHint':           'شكراً على المراجعة...',
    'expertReplyError':          'خطأ في حفظ الرد: {error}',
    'expertPublishReply':        'نشر الرد',
    'expertBookForTime':         'احجز لـ {time}',
    'expertStartingFrom':        'ابتداءً من ₪{price}',
    'expertSelectDateTime':      'اختر التاريخ والوقت',
    'expertBookingSummaryTitle':   'ملخص الحجز الآمن',
    'expertSummaryRowService':     'الخدمة',
    'expertSummaryRowDate':        'التاريخ',
    'expertSummaryRowTime':        'الساعة',
    'expertSummaryRowPrice':       'سعر الخدمة',
    'expertSummaryRowProtection':  'حماية AnySkill',
    'expertSummaryRowIncluded':    'مشمول ✓',
    'expertSummaryRowTotal':       'المجموع المستحق',
    'expertCancellationNotice':    'سياسة الإلغاء: {policy} — إلغاء مجاني حتى {deadline}. الإلغاء بعد ذلك: غرامة {penalty}%.',
    'expertCancellationNoDeadline':'سياسة الإلغاء: {policy} — {description}.',
    'expertConfirmPaymentButton':  'تأكيد الدفع وحجز الموعد',
    'expertSectionAbout':         'عن الخبير',
    'expertSectionService':       'اختر الخدمة',
    'expertSectionGallery':       'المعرض',
    'expertSectionSchedule':      'اختر موعداً للخدمة',
    'tosFullTitle':           'شروط الاستخدام والخصوصية',
    'tosLastUpdated':         'آخر تحديث: مارس 2026  |  الإصدار 2.0',
    'tosBindingNotice':       'هذه الاتفاقية ملزمة. يرجى القراءة بعناية قبل الموافقة.',
    'tosAcceptButton':        'قرأت وفهمت وأوافق على الشروط',
    'financeTitle':           'حسابي',
    'financeTrustBadge':      'ضمان AnySkill',
    'financeAvailableBalance': 'الرصيد القابل للسحب',
    'financeMinWithdraw':     'الحد الأدنى للسحب: ₪50',
    'financeWithdrawButton':  'سحب الأموال',
    'financeRecentActivity':  'النشاط الأخير',
    'financeError':           'خطأ: {error}',
    'financeNoTransactions':  'لا توجد عمليات في حسابك بعد',
    'financePaidTo':          'دفعت لـ {name}',
    'financeReceivedFrom':    'استلمت من {name}',
    'financeProcessing':      'جارٍ المعالجة...',
    'financePending':         'قيد الانتظار',
    'financeAddFunds':        'إضافة أموال',
    'financeAddFundsInfo':    'يتم إيداع الأموال في المحفظة تلقائياً بعد أن يدفع العميل ويؤكد إتمام العمل. لا حاجة لإضافة أموال يدوياً.',
    'withdrawMinBalance':     'الحد الأدنى للرصيد القابل للسحب: ₪{amount}',
    'withdrawAvailableBalance': 'الرصيد المتاح للسحب',
    'withdrawTaxStatusTitle': 'اختر حالتك الضريبية',
    'withdrawTaxStatusSubtitle': 'مطلوب لمعالجة الدفع وفقاً للقانون',
    'withdrawTaxBusiness':    'صاحب عمل مسجّل',
    'withdrawTaxBusinessSub': 'عامل معفى / عامل مرخّص / شركة',
    'withdrawTaxIndividual':  'فرد (بدون رخصة عمل)',
    'withdrawTaxIndividualSub': 'موظف / مستقل بدون ملف ضريبي',
    'withdrawTaxIndividualBadge': 'سهل وسريع',
    'withdrawEncryptedNotice': 'بياناتك مؤمّنة ومشفّرة',
    'withdrawBankEncryptedNotice': 'بياناتك المصرفية مشفّرة ومؤمّنة',
    'withdrawCertSection':    'شهادة العمل',
    'withdrawBankSection':    'تفاصيل الحساب المصرفي',
    'withdrawBankName':       'اسم البنك',
    'withdrawBankBranch':     'رقم الفرع',
    'withdrawBankAccount':    'رقم الحساب',
    'withdrawBankRequired':   'يجب اختيار بنك',
    'withdrawBranchRequired': 'مطلوب',
    'withdrawAccountMinDigits': '4 أرقام كحد أدنى',
    'withdrawSelectBankError': 'اختر اسم البنك',
    'withdrawNoCertError':    'يجب رفع شهادة العمل قبل المتابعة',
    'withdrawNoDeclarationError': 'يجب الموافقة على إقرار المسؤولية الضريبية قبل المتابعة',
    'withdrawUploadError':    'خطأ في رفع الملف — حاول مرة أخرى',
    'withdrawSubmitError':    'خطأ في إرسال الطلب — حاول مرة أخرى',
    'withdrawSubmitButton':   'إرسال طلب سحب — {amount}',
    'withdrawSuccessTitle':   'تم استلام الطلب! 🎉',
    'withdrawSuccessSubtitle': 'طلب سحب بقيمة {amount} تم إرساله للمعالجة',
    'withdrawSuccessNotice':  'سيتم تحديث رصيدك بعد معالجة الطلب من قبل الفريق. للاستفسارات: support@anyskill.co.il',
    'withdrawTimeline1Title': 'تم استلام الطلب',
    'withdrawTimeline1Sub':   'تم إرسال رقم المرجع إلى بريدك الإلكتروني',
    'withdrawTimeline2Title': 'المراجعة والتحقق',
    'withdrawTimeline2Sub':   'فريق AnySkill يتحقق من البيانات',
    'withdrawTimeline3Title': 'الأموال في الحساب',
    'withdrawTimeline3Sub':   'خلال 3-5 أيام عمل',
    'withdrawDeclarationText': 'أُقرّ بمسؤوليتي الحصرية عن الإبلاغ الضريبي وفقاً للقانون ',
    'withdrawDeclarationSection': '(البند 6 في النظام)',
    'withdrawDeclarationSuffix': '. أعلم أن AnySkill ليست جهة توظيفي ولا تخصم ضرائب من المصدر.',
    'withdrawExistingCert':   'شهادة موجودة',
    'withdrawCertUploadBtn':  'رفع شهادة العمل',
    'withdrawCertReplace':    'اضغط للاستبدال',
    'withdrawCertHint':       'JPG / PNG — شهادة عامل معفى/مرخّص',
    'withdrawIndividualTitle': 'فاتورة للموظف — خدمة شريكنا',
    'withdrawIndividualDesc': 'ليس لديك عمل مسجّل؟ لا مشكلة! من خلال خدمة "فاتورة للموظف" يمكننا إتمام الدفع بشكل قانوني تماماً. ستُطبّق رسوم خدمة بسيطة.',
    'withdrawBankTransferPending': 'سحب إلى الحساب المصرفي — قيد المعالجة',
    'withdrawBusinessFormTitle': 'صاحب عمل مسجّل',
    'withdrawIndividualFormTitle': 'فرد (بدون رخصة)',
    'onboardingStep':         'الخطوة {step} من {total}',
    'onboardingWelcome':      'مرحباً بك في AnySkill! 👋',
    'onboardingWelcomeSub':   'أخبرنا من أنت حتى نتمكن من تخصيص التجربة لك',
    'onboardingRoleCustomerTitle': 'أبحث عن خدمة',
    'onboardingRoleCustomerSub': 'أريد حجز خبراء لاحتياجاتي',
    'onboardingRoleProviderTitle': 'أقدّم خدمة',
    'onboardingRoleProviderSub': 'لديّ مهارة وأريد العمل عبر AnySkill',
    'onboardingBothRoles':    'ممتاز! يمكنك الحجز وتقديم الخدمات أيضاً.',
    'onboardingServiceTitle': 'تفاصيل خدمتك',
    'onboardingServiceSub':   'ما هو مجال تخصصك وما هو سعرك بالساعة؟',
    'onboardingCategory':     'مجال التخصص',
    'onboardingCategoryHint': 'اختر مجالاً...',
    'onboardingPriceLabel':   'السعر بالساعة (₪)',
    'onboardingPriceHint':    'مثال: 150',
    'onboardingPriceTip':     'متوسط السعر في هذه الفئة هو ₪100–₪200 بالساعة.',
    'onboardingProfileTitle': 'ملفك الشخصي',
    'onboardingProfileSub':   'صورة ووصف مختصر يساعدان الناس على الوثوق بك',
    'onboardingAddPhoto':     'أضف صورة ملف شخصي',
    'onboardingBioLabel':     'بضع كلمات عنك (اختياري)',
    'onboardingBioHint':      'أخبرنا قليلاً عن نفسك...',
    'onboardingSkipFinish':   'تخطَّ واضغط للإنهاء',
    'onboardingNext':         'التالي',
    'onboardingStart':        'ابدأ باستخدام AnySkill',
    'onboardingError':        'خطأ: {error}',
    'onboardingUploadError':  'خطأ في الرفع: {error}',
    'onboardingTaxTitle':         'التحقق من الضرائب والترخيص',
    'onboardingTaxSubtitle':      'مطلوب قبل استلام أعمال على المنصة',
    'onboardingTaxNotice':        'AnySkill منصة مهنية حصرياً. نحن ملتزمون بالتحقق من وثائقك الضريبية قبل أن تتمكن من استلام حجوزات — لسلامتك وسلامة العملاء.',
    'onboardingTaxStatusLabel':   'الحالة الضريبية',
    'onboardingTaxStatusRequired':'يجب اختيار حالة ضريبية قبل المتابعة',
    'onboardingDocRequired':      'يجب رفع مستند قبل المتابعة',
    'onboardingTaxBusiness':      'عامل مسجّل (معفى / مرخّص)',
    'onboardingTaxBusinessSub':   'صاحب عمل مسجّل لدى ضريبة القيمة المضافة',
    'onboardingTaxIndividual':    'فاتورة عبر طرف ثالث',
    'onboardingTaxIndividualSub': 'موظف — سنصدر فاتورة باسمك عبر شريك',
    'onboardingDocLabelBusiness': 'شهادة مسك الدفاتر / فتح ملف',
    'onboardingDocLabelIndividual':'صورة بطاقة الهوية',
    'onboardingDocHintBusiness':  'صوّر الشهادة التي حصلت عليها من ضريبة القيمة المضافة (JPG / PNG)',
    'onboardingDocHintIndividual':'صوّر وجهي بطاقة الهوية (JPG / PNG)',
    'onboardingDocUploadPrompt':  'اضغط لاختيار ملف من المعرض',
    'onboardingDocUploadSub':     'JPG · PNG · PDF · حد أقصى 10MB',
    'onboardingUploading':        'جارٍ الرفع...',
    'onboardingDocUploaded':      'تم الرفع بنجاح ✓',
    'onboardingDocReplace':       'استبدال',
    'oppUnderReviewTitle':    'الحساب قيد المراجعة',
    'oppUnderReviewSubtitle': 'نحن نتحقق من مستنداتك الضريبية',
    'oppUnderReviewBody':     'AnySkill منصة مهنية حصرياً. فريقنا يراجع المستندات التي قدمتها وسيوافق على حسابك خلال 24–48 ساعة.\n\nستتلقى إشعاراً فور الموافقة على الحساب وستتمكن من البدء في استلام الحجوزات.',
    'oppUnderReviewStep1':    'تم استلام المستندات',
    'oppUnderReviewStep2':    'مراجعة المسؤول',
    'oppUnderReviewStep3':    'حساب نشط',
    'oppUnderReviewContact':  'للاستفسارات: support@anyskill.co.il',
    'adminVerifyProvider':    'تحقق من المزوّد',
    'adminUnverifyProvider':  'إلغاء التحقق من المزوّد',
    'adminVerifiedSuccess':   'تم التحقق من {name} — تم تفعيل الوصول إلى الأعمال ✓',
    'adminUnverifiedSuccess': 'تم إلغاء التحقق من {name}',
    'adminViewDoc':           'عرض المستند',
    'adminComplianceSection': 'الامتثال والضرائب',
    'adminComplianceTaxStatus': 'الحالة الضريبية',
    'adminCompliancePending': 'بانتظار التحقق',
    'adminComplianceApproved':'مُعتمد',
    // ── Help Center screen ────────────────────────────────────────────────
    'helpCenterProviderSupport': 'دعم مقدمي الخدمات',
    'helpCenterCustomerSupport': 'دعم العملاء',
    'helpCenterProviderWelcome': 'مرحباً! أنا مساعد الخبراء في AnySkill 👋\nستجد هنا نصائح لإدارة ملفك الشخصي، الحصول على حجوزات، والمزيد.\n\nكيف يمكنني مساعدتك اليوم؟',
    'helpCenterCustomerWelcome': 'مرحباً! أنا مساعد العملاء في AnySkill 👋\nلديّ إجابات لكل سؤال — اختر من القائمة أو اكتب بحرية.\n\nكيف يمكنني مساعدتك؟',
    'helpCenterProviderFaq':  'أسئلة شائعة لمقدمي الخدمات',
    'helpCenterCustomerFaq':  'أسئلة شائعة للعملاء',
    'helpCenterInputHint':    'اكتب سؤالاً...',
    'helpCenterTitle':        'مركز المساعدة',
    // ── Dispute Resolution ────────────────────────────────────────────────────
    'disputeOpenDisputes':    'نزاعات مفتوحة',
    'disputeLockedEscrow':    'محجوز في الأمانة',
    'disputeTapForDetails':   'اضغط للتفاصيل والإجراءات',
    'disputePartyCustomer':   'عميل',
    'disputePartyProvider':   'مقدم خدمة',
    'disputeArbitrationCenter': 'مركز التحكيم',
    'disputeIdPrefix':        'المعرّف:',
    'disputeLockedSuffix':    'محجوز',
    'disputePartiesSection':  'الأطراف',
    'disputeReasonSection':   'سبب النزاع',
    'disputeNoReason':        'لم يُذكر سبب.',
    'disputeChatHistory':     'سجل المحادثة (آخر 10 رسائل)',
    'disputeAdminNote':       'ملاحظة المشرف (اختياري)',
    'disputeAdminNoteHint':   'أضف ملاحظة ستُحفظ في سجل القرار...',
    'disputeExistingNote':    'ملاحظة موجودة: {note}',
    'disputeActionsSection':  'إجراءات التحكيم',
    'disputeResolving':       'جارٍ تنفيذ الإجراء...',
    'disputeRefundLabel':     'استرداد للعميل',
    'disputeRefundSublabel':  'استرداد كامل ₪{amount}',
    'disputeReleaseLabel':    'تحرير للخبير',
    'disputeReleaseSublabel': 'بعد العمولة (≈₪{amount})',
    'disputeSplitLabel':      'تسوية 50/50',
    'disputeSplitSublabel':   '₪{amount} لكل طرف',
    'disputeConfirmRefund':   'استرداد كامل للعميل',
    'disputeConfirmRelease':  'تحرير للخبير',
    'disputeConfirmSplit':    'تسوية 50/50',
    'disputeRefundBody':      '₪{amount} سيُعاد إلى {name}.\nالخبير لن يتلقى أي دفعة.',
    'disputeReleaseBody':     '₪{amount} سيُحوَّل إلى {name}\n(بعد عمولة {fee}%).',
    'disputeSplitBody':       '₪{half} ← عميل\n₪{halfNet} ← خبير (بعد العمولة)\n₪{platform} ← المنصة',
    'disputeIrreversible':    'هذا الإجراء لا يمكن التراجع عنه. سيُحفظ القرار وسيُرسل إشعار FCM لكلا الطرفين.',
    'disputeResolvedRefund':  '✅ تم استرداد المبلغ للعميل. تم إرسال إشعار لكلا الطرفين.',
    'disputeResolvedRelease': '✅ تم تحرير المبلغ للخبير. تم إرسال إشعار لكلا الطرفين.',
    'disputeResolvedSplit':   '⚖️ تمت التسوية. تم إرسال إشعار لكلا الطرفين.',
    'disputeErrorPrefix':     'خطأ: {error}',
    'disputeNoChatId':        'لا يوجد معرّف محادثة.',
    'disputeNoMessages':      'لا توجد رسائل في المحادثة.',
    'disputeSystemSender':    'النظام',
    'disputeTypeImage':       '📷 صورة',
    'disputeTypeLocation':    '📍 موقع',
    'disputeTypeAudio':       '🎤 تسجيل صوتي',
    'disputeOpenedAt':        'تم الفتح في {date}',
    'disputeEmptyTitle':      'لا توجد نزاعات مفتوحة',
    'disputeEmptySubtitle':   'كل شيء على ما يرام 🎉',
    // ── My Calendar ───────────────────────────────────────────────────────────
    'calendarTitle':          'يومياتي',
    'calendarRefresh':        'تحديث',
    'calendarNoEvents':       'لا توجد حجوزات في هذا اليوم',
    'calendarStatusPending':  'بانتظار التنفيذ',
    'calendarStatusWaiting':  'بانتظار الموافقة',
    'calendarStatusCompleted': 'مكتمل',
    // ── My Requests ───────────────────────────────────────────────────────────
    'requestsTitle':          'طلباتي',
    'requestsEmpty':          'لا توجد طلبات نشطة',
    'requestsEmptySubtitle':  'أرسل طلباً سريعاً وخلال ثوانٍ\nسيتواصل معك مقدمو خدمات محترفون!',
    'requestsInterested':     '{count} مهتمّون',
    'requestsWaiting':        'بانتظار المهتمين...',
    'requestsWaitingProviders': 'بانتظار مقدمي خدمات مهتمين...',
    'requestsClosed':         'تم إغلاق الطلب',
    'requestsViewInterested': 'عرض {count} مهتمّين',
    'requestsInterestedTitle': 'المهتمون بطلبك',
    'requestsNoInterested':   'لا يوجد مهتمون بعد',
    'requestsJustNow':        'الآن',
    'requestsMinutesAgo':     'منذ {minutes} دقيقة',
    'requestsHoursAgo':       'منذ {hours} ساعة',
    'requestsDaysAgo':        'منذ {days} أيام',
    'requestsDefaultExpert':  'خبير',
    'requestsHiredAgo':       'تم التعاقد {ago}',
    'requestsOrderCount':     '🔥 {count} حجوزات',
    'requestsTopMatch':       'أفضل تطابق',
    'requestsMatchLabel':     'تطابق',
    'requestsChatNow':        'تحدّث الآن',
    'requestsConfirmPay':     'تأكيد والدفع',
    'requestsMoneyProtected': 'المبلغ محمي حتى انتهاء العمل',
    'requestsEscrowTooltip':  'يُحتفظ بالمبلغ في أمانة AnySkill ويُحوَّل إلى الخبير فقط بعد موافقتك عند انتهاء العمل.',
    'requestsVerifiedBadge':  'AnySkill Verified — دفع آمن في الأمانة',
    'requestsPricePerHour':   '₪{price} / ساعة',
    'requestsBestValue':      'الأفضل قيمة',
    'requestsFastResponse':   'استجابة سريعة',
    // ── XP Manager ────────────────────────────────────────────────────────────
    'xpManagerTitle':         'XP ونظام المستويات',
    'xpManagerSubtitle':      'إعداد الأحداث والنقاط وحدود الترقية',
    'xpEventsSection':        'أحداث XP',
    'xpEventsCount':          '{count} أحداث',
    'xpEventsEmpty':          'لا توجد أحداث بعد.\nاضغط "إضافة حدث" للبدء.',
    'xpAddEventButton':       'إضافة حدث',
    'xpEditEventTitle':       'تعديل حدث XP',
    'xpAddEventTitle':        'إضافة حدث XP جديد',
    'xpFieldId':              'معرّف الحدث (بالإنجليزية، بدون مسافات)',
    'xpFieldIdHint':          'e.g. late_delivery',
    'xpFieldName':            'اسم الحدث',
    'xpFieldPoints':          'نقاط XP (سالب = عقوبة)',
    'xpFieldDesc':            'وصف مختصر',
    'xpEventUpdated':         'تم تحديث الحدث ✓',
    'xpEventAdded':           'تمت إضافة الحدث ✓',
    'xpEventDeleted':         'تم حذف الحدث',
    'xpDeleteEventTitle':     'حذف الحدث',
    'xpDeleteEventConfirm':   'حذف الحدث "{name}"?\nهذا الإجراء لا يمكن التراجع عنه.',
    'xpReservedId':           'المعرّف "app_levels" محجوز للنظام',
    'xpTooltipEdit':          'تعديل',
    'xpTooltipDelete':        'حذف',
    'xpLevelsTitle':          'حدود الترقية',
    'xpLevelsSubtitle':       'حدّد الحد الأدنى من XP المطلوب لكل مستوى.',
    'xpSaveLevels':           'حفظ حدود المستويات',
    'xpLevelsSaved':          'تم تحديث حدود المستويات ✓',
    'xpLevelsError':          'الفضة يجب أن تكون > 0 والذهب يجب أن يكون > الفضة',
    'xpLevelBronze':          'برونزي',
    'xpLevelSilver':          'فضي',
    'xpLevelGold':            'ذهبي',
    'xpSaveAction':           'حفظ',
    'xpAddAction':            'إضافة',
    'xpErrorPrefix':          'خطأ: {error}',
    // ── System Wallet ─────────────────────────────────────────────────────────
    'systemWalletTitle':      'إدارة أموال النظام',
    'systemWalletBalance':    'الرصيد المتاح في محفظة النظام',
    'systemWalletPendingFees': 'عمولات قيد الانتظار',
    'systemWalletActiveJobs': '{count} معاملات نشطة (أمانة / بانتظار الموافقة)',
    'systemWalletFeePanel':   'تحديد نسبة العمولة العامة',
    'systemWalletUpdateFee':  'تحديث',
    'systemWalletFeeUpdated': 'تم تحديث العمولة إلى {value}%!',
    'systemWalletEnterNumber': 'يرجى إدخال رقم',
    'systemWalletInvalidNumber': 'يرجى إدخال رقم صحيح',
    'systemWalletEarningsTitle': 'تفصيل إيرادات العمولات (وقت فعلي)',
    'systemWalletExportCsv':  'تصدير CSV',
    'systemWalletExported':   'تم تصدير {count} سجلات إلى CSV',
    'systemWalletExportError': 'خطأ في التصدير: {error}',
    'systemWalletNoEarnings': 'لا توجد عمولات مسجلة في النظام',
    'systemWalletTxStatus':   'الحالة: تم الاستلام بنجاح',
    // ── Pending Categories ────────────────────────────────────────────────────
    'pendingCatsTitle':       'فئات بانتظار الموافقة',
    'pendingCatsSectionPending': 'بانتظار الموافقة',
    'pendingCatsSectionReviewed': 'تمت المراجعة',
    'pendingCatsApproved':    '✅ تمت الموافقة على الفئة ونُشرت!',
    'pendingCatsRejected':    '🗑 تم رفض الفئة',
    'pendingCatsErrorPrefix': 'خطأ: {error}',
    'pendingCatsSubCategory': 'فئة فرعية: {name}',
    'pendingCatsProviderDesc': 'وصف مقدم الخدمة',
    'pendingCatsAiReason':    'تبرير الذكاء الاصطناعي',
    'pendingCatsImagePrompt': 'أمر توليد الصورة (Midjourney/DALL-E)',
    'pendingCatsReject':      'رفض',
    'pendingCatsApprove':     'موافقة ونشر',
    'pendingCatsStatusApproved': 'مُوافق عليه',
    'pendingCatsStatusRejected': 'مرفوض',
    'pendingCatsEmptyTitle':  'لا توجد فئات معلّقة',
    'pendingCatsEmptySubtitle': 'تمت الموافقة على جميع الفئات أو لم تُنشأ بعد',
    'pendingCatsOpenedAt':    'تم الفتح في {date}',
    // ── Home Tab (New Keys) ─────────────────────────────────────────────────
    'homeCategoryNotFound':   'لم يتم العثور على فئة لـ "{query}"',
    'homeCategoryCount':      '{count} فئات',
    'homeShowAll':            'عرض الكل',
    'homeCommunityButton':    'من أجل المجتمع',
    'homeUrgentSearch':       'بحث عاجل',
    'reengagementDefaultMessage': 'مستعد للحجز مجدداً؟',
    'reengagementBadgeLabel': 'اقتراح ذكي',
    'reengagementCtaButton':  'احجز الآن',
    'bannerWelcomeTitle':     'مرحباً بك في AnySkill',
    'bannerWelcomeSubtitle':  'اعثر على خبراء من حيّك',
    'bannerProfessionalTitle': 'خدمة احترافية بضغطة واحدة',
    'bannerProfessionalSubtitle': 'ترميمات • تنظيف • تصوير والمزيد',
    'bannerBecomeExpertTitle': 'كن خبيراً اليوم',
    'bannerBecomeExpertSubtitle': 'انشر خدمتك وابدأ بالكسب',
    'adminEmailTestSent':     'تم إرسال بريد اختباري! تحقق من صندوق الوارد.',
    'defaultExpertName':      'الخبير',
    // ── Search Bar & Filters ────────────────────────────────────────────────
    'searchBarHint':          'ماذا تريد أن تفعل اليوم؟',
    'searchFilterPlumber':    'سبّاك',
    'searchFilterElectrician': 'كهربائي',
    'searchFilterCleaning':   'تنظيف',
    'searchFilterGardening':  'بستنة',
    'searchFilterPrivateLessons': 'دروس خصوصية',
    'searchFilterBusinessConsulting': 'استشارات أعمال',
    'searchFilterDesign':     'تصميم',
    'searchFilterTranslation': 'ترجمة',
    'searchFilterMassage':    'تدليك',
    'searchFilterFitness':    'لياقة بدنية وتدريب',
    'searchFilterBeauty':     'تجميل',
    'searchFilterNutrition':  'تغذية',
    'searchFilterMusic':      'موسيقى',
    'searchFilterPainting':   'رسم',
    'searchFilterWriting':    'كتابة',
    'searchFilterCoding':     'برمجة',
    // ── Expert Card & Stories ──────────────────────────────────────────────
    'expertCardLiveStoryBadge': 'قصة مباشرة',
    'storiesRowSectionTitle': 'قصص مقدمي الخدمات',
    'storiesRowActiveCount':  '{count} نشط{isPlural}',
    'storiesMyStoryLabel':    'قصتي',
    'storiesAddStoryLabel':   'أضف قصة',
    'storiesDefaultProviderName': 'أنا',
    'defaultProviderName':    'مقدم خدمة',
    'storiesTimeRemainingHours': '{hours}س',
    'storiesTimeRemainingMinutes': '{minutes}د',
    'storiesDeleteDialogTitle': 'حذف القصة؟',
    'storiesDeleteDialogBody': 'سيتم حذف القصة نهائياً ولا يمكن استعادتها.',
    'storiesDeleteConfirmButton': 'حذف',
    'storiesDeletedSnackbar':  'تم حذف القصة بنجاح 🗑️',
    'storiesLikeNotificationTitle': '❤️ إعجاب بقصة {name}',
    'storiesQuickReplyAvailability': 'هل أنت متاح في منطقتي؟',
    'storiesQuickReplyCost': 'ما تكلفة الزيارة؟',
    'storiesQuickReplySendPhoto': 'هل يمكنني إرسال صورة للمشكلة؟',
    'storiesLoadError':       'تعذّر تحميل القصة',
    'storiesAvailableNow':    'متاح الآن',
    'storiesBookOrMessageButton': 'احجز الآن / أرسل رسالة',
    'storiesViewFullProfileLink': 'عرض الملف الشخصي الكامل والأسعار ←',
    'storiesUploadSourceTitle': 'اختر المصدر',
    'storiesUploadGalleryLabel': 'المعرض',
    'storiesUploadGallerySub': 'اختر فيديو موجود',
    'storiesUploadCameraLabel': 'الكاميرا',
    'storiesUploadCameraSub': 'صوّر الآن',
    'storiesNewStoryNotificationTitle': '📱 قصة جديدة: {name}',
    'storiesNewStoryNotificationDetail': 'الخدمة: {service}',
    'storiesPublishedSnackbar': 'تم نشر قصتك! ✨ صالحة لمدة 24 ساعة',
    'storiesUploadErrorPermission': 'خطأ في الأذونات — حاول تسجيل الدخول مجدداً',
    'storiesUploadCancelled': 'تم إلغاء الرفع',
    'storiesUploadErrorNetwork': 'خطأ في الشبكة — تحقق من الاتصال وحاول مجدداً',
    'storiesUploadErrorGeneric': 'خطأ في الرفع — حاول مجدداً',
    'storiesUploadPanelTitle': 'قصة مهارة',
    'storiesUploadPanelSubtitle': 'استعرض موهبتك • صالحة 24 ساعة',
    'storiesPerkSearchBoost': 'تعزيز في البحث',
    'storiesPerk24Hours':     '24 ساعة',
    'storiesSelectVideoButton': 'اختر فيديو من المعرض',
    'storiesVideoRecommendedLength': 'يُنصح بحد أقصى 60 ثانية',
    'storiesReplaceVideoButton': 'استبدال الفيديو',
    'storiesUploadingProgress': 'جارٍ الرفع... {percent}%',
    'storiesPreparingUpload': 'جارٍ التحضير...',
    'storiesPublishButton':   'نشر القصة',
    // ── Bookings & Orders ────────────────────────────────────────────────────
    'bookingsAppBarExpert':   'أعمالي',
    'bookingsAppBarCustomer': 'حجوزاتي',
    'bookingsTabCalendar':    'اليوميات',
    'bookingsTabMyTasks':     'مهامي',
    'bookingsTabActive':      'نشطة',
    'bookingsTabHistory':     'السجل',
    'bookingsAvailabilityTitle': 'إدارة التوفر',
    'bookingsAvailabilityHint': 'اضغط على تاريخ للاختيار. ضغطة طويلة للحظر/الإلغاء.',
    'bookingsCalendarBlocked': 'محظور',
    'bookingsCalendarBooking': 'حجز',
    'calendarFormatMonth':    'شهر',
    'bookingsBlockedDatesLabel': 'تواريخ محظورة:',
    'bookingsSaveBlockedDates': 'حفظ التواريخ المحظورة',
    'bookingDetailsTitle':    'تفاصيل الحجز',
    'bookingDetailId':        'معرّف الحجز',
    'bookingDetailExpert':    'الخبير',
    'bookingDetailCustomer':  'العميل',
    'bookingDetailStatus':    'الحالة',
    'bookingDetailAmount':    'المبلغ',
    'bookingDetailDate':      'التاريخ',
    'bookingDetailTime':      'الوقت',
    'bookingCancelDialogTitle': 'إلغاء الحجز',
    'bookingCancelPenaltyWarning': 'تحذير: انتهت فترة الإلغاء المجاني...',
    'bookingCancelConfirmMessage': 'هل تريد إلغاء الحجز؟ ₪{amount} ستُعاد إلى محفظتك.',
    'bookingCancelRefundBreakdown': 'ستسترد: ₪{customer}\nسيُدفع للخبير: ₪{expert}',
    'bookingCancelYesPenalty': 'نعم، إلغاء (غرامة ₪{penalty})',
    'bookingCancelYes':       'نعم، إلغاء',
    'bookingCancelledRefundSnackbar': 'تم إلغاء الحجز — ₪{amount} أُعيدت إلى المحفظة',
    'bookingErrorCancelling': 'خطأ في الإلغاء: {error}',
    'bookingProviderCancelTitle': 'إلغاء من مقدم الخدمة',
    'bookingProviderCancelMessage': 'الإلغاء من مقدم الخدمة يُعيد للعميل 100%...',
    'bookingProviderCancelledSnackbar': 'تم إلغاء الحجز — سيحصل العميل على استرداد كامل',
    'bookingTipDialogTitle': 'إرسال إكرامية',
    'bookingTipConfirmMessage': 'إرسال ₪{amount} إكرامية إلى {expert}؟',
    'bookingTipSendButton':   'إرسال',
    'bookingTipSentSnackbar': 'تم إرسال ₪{amount} إلى {expert} 🎉',
    'bookingTipErrorSnackbar': 'خطأ في إرسال الإكرامية: {error}',
    'bookingReviewPromptTitle': 'كيف كانت الخدمة؟',
    'bookingSubmitReviewButton': 'إرسال التقييم ⭐',
    'bookingReviewSentConfirmation': 'تم إرسال التقييم — شكراً!',
    'bookingReceiptChip':     'إيصال',
    'bookingAmountEscrow':    'في الأمانة',
    'bookingAmountLabel':     'المبلغ',
    'bookingReleasePaymentButton': 'تأكيد وتحرير الدفعة',
    'bookingOpenDisputeButton': 'هناك مشكلة — فتح نزاع',
    'bookingCancelButton':    'إلغاء الحجز',
    'bookingTipLabel':        'إرسال إكرامية:',
    'bookingExpertOnTheWay':  'الخبير في الطريق إليك',
    'bookingViewExpertOnMap': 'عرض الخبير على الخريطة 📍',
    'bookingWorkStartedMinutesAgo': 'بدأ العمل منذ {minutes} دقائق',
    'bookingRebookButton':    'إعادة حجز {expert}',
    'bookingCallExpertButton': '📞 اتصل بالخبير',
    'bookingQuickChatButton': '💬 محادثة سريعة',
    'bookingDetailsFooter':   'تفاصيل الحجز',
    'bookingStepReceived':    'تم الاستلام',
    'bookingStepOnTheWay':    'في الطريق',
    'bookingStepInProgress':  'قيد التنفيذ',
    'bookingStepDone':        'مكتمل',
    'bookingNavigateButton':  'التنقل إلى العمل 🚗',
    'bookingStartWorkButton': 'وصلتُ — بدء العمل 🛠️',
    'bookingMarkDoneButton':  'أنهيتُ العمل',
    'bookingChatWithCustomerButton': 'محادثة مع العميل',
    'bookingWaitingForClientApproval': 'بانتظار موافقة العميل',
    'bookingShowReceiptButton': 'عرض الإيصال',
    'bookingShareReviewButton': 'مشاركة التقييم ⭐',
    'bookingReviewWindowExpired': 'انتهت فترة التقييم (7 أيام)',
    'bookingsEarningsSummaryLabel': 'إجمالي الأرباح المتوقعة',
    'bookingsActiveCountLabel': 'حجوزات',
    'bookingLoadError':       'تعذّر تحميل الحجوزات حالياً. يرجى المحاولة مجدداً.',
    'bookingsEmptyExpertTitle': 'لا توجد مهام بعد',
    'bookingsEmptyHistoryTitle': 'لا يوجد سجل حجوزات',
    'bookingsEmptyCustomerTitle': 'لديك مهمة؟ لدينا الشخص المناسب لها.',
    'bookingsEmptyExpertSubtitle': 'ستظهر حجوزات العملاء هنا. تأكد من تحديث ملفك الشخصي.',
    'bookingsEmptyHistorySubtitle': 'ستظهر الحجوزات المكتملة هنا.',
    'bookingsEmptyCustomerSubtitle': 'لا تقبل بأقل من الأفضل. هل نبدأ؟',
    'bookingsEmptyCtaButton': 'احجز خدمة الآن',
    'bookingsGroupActive':    'نشط',
    'bookingsGroupHistory':   'السجل',
    'bookingsGroupThisMonth': 'هذا الشهر',
    'bookingsGroupLastMonth': 'الشهر الماضي',
    'bookingsGroupOlder':     'أقدم',
    'bookingExpertCompletedMessage': '✅ أنهى الخبير العمل! اضغط على "تأكيد وتحرير"...',
    'bookingErrorSaving':     'خطأ في الحفظ: {error}',
    'defaultCustomerName':    'عميل',
    'bookingStatusUpdateFailed': 'لم يتم تحديث الحالة — حاول مجدداً (status: {status})',
    'bookingTimeoutError':    'انتهت المهلة',
    'bookingPermissionError': 'لا توجد صلاحية للتحديث...',
    // ── Booking Status Badges ────────────────────────────────────────────────
    'statusPendingCompletion': 'بانتظار الإنهاء',
    'statusPendingApproval':  'بانتظار الموافقة',
    'statusCompleted':        'مكتمل',
    'statusCancelled':        'ملغى',
    'statusDisputed':         'قيد النزاع',
    'statusSplitResolved':    'تمت التسوية',
    'statusCancelledWithPenalty': 'ملغى (غرامة)',
    'statusBadgeEscrow':      'في الأمانة',
    'statusBadgePending':     'بانتظار الموافقة',
    'statusBadgeCompleted':   'مكتمل',
    'statusBadgeCancelled':   'ملغى',
    'statusBadgeCancelledPenalty': 'ملغى+غرامة',
    'statusBadgeDisputed':    'قيد النزاع',
    'statusBadgeRefunded':    'مُسترد',
    'statusBadgeSplit':       'تسوية',
    'statusBadgeInProgress':  'قيد المعالجة',
    // ── Opportunities ────────────────────────────────────────────────────────
    'oppSortNearest':         '📍 الأقرب',
    'oppSortMostProfitable':  '💰 الأكثر ربحاً',
    'oppSortUrgent':          '🔥 عاجل',
    'oppNearbyBadge':         '🔥 قريب منك',
    'oppViewOnMap':           'عرض الموقع على الخريطة',
    'oppViewersCounter':      '{viewers} خبراء آخرون يراجعون هذا العرض',
    'aiCoachCtaTitle':        '🤖 تحليل AI — كيف تحصل على المزيد من الأعمال؟',
    'aiCoachCtaSubtitle':     'اضغط لتحليل مجاني لملفك الشخصي',
    'aiCoachLoadingText':     'جارٍ تحليل ملفك الشخصي...',
    'aiCoachRefreshButton':   'تحديث التحليل',
    'aiCoachUpdatedAgo':      'تم التحديث منذ {time}',
  },
};
...
class AppLocalizations {
  ...
  String get languageAr               => _t('languageAr');
  ...
  String authError(String code) {
    switch (code) {
      ...
      // Common codes missed in original mapper — cause "שגיאה בהתחברות" at scale
      case 'channel-error':          return errorNetworkFailed;
      case 'internal-error':         return errorGenericLogin;
      case 'operation-not-allowed':  return errorGenericLogin;
      case 'popup-closed-by-user':   return errorGenericLogin;
      case 'cancelled-popup-request':return errorGenericLogin;
      case 'web-context-cancelled':  return errorGenericLogin;
      case 'account-exists-with-different-credential':
                                     return errorInvalidCredential;
      // Default: include the error code so users/support can diagnose
      default:                       return '$errorGenericLogin ($code)';
    }
  }
  ...
  static const List<Locale> supportedLocales = [_he, _en, _es, _ar];
}
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      ['he', 'en', 'es', 'ar'].contains(locale.languageCode);
